...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Class_teacher/sms_send_popup_individual/'.$master_id.'/'.$student_id.'/'.$class_id); ?>
       ...
       <div style="padding-left:450px;">
        ...
        <?php 
                 ...
                 echo anchor(base_url() . 'index.php/Class_teacher/delete_sms_pop_up/' .$master_id .'/student_view', 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
