...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php/Class_teacher/tab_sheet_class');?>
...
if($('#send_grade').prop('checked') == true) {
	...
	var page_from='tab_sheet_class';
    $(".preloader").show();
	$.ajax({
	    url: '<?php echo base_url();?>index.php/Class_teacher/subject_message1/' + class_id + '/' + section_id + '/' + exam_id + '/' +  grade + '/' + position +'/' +rmark +'/' + page_from, 
...
function send_message1(class_id,section_id,exam_id, subject_id){
 ...
 // alert(grade);
  //alert(position);
    $(".preloader").show();
	$.ajax({
	    url: '<?php echo base_url();?>index.php/Class_teacher/subject_message_individual1/' + class_id + '/' + section_id + '/' + exam_id + '/' + subject_id + '/' +  grade + '/' + position+ '/' + rmark +'/' + page_from ,
            success: function(response)
            {
				jQuery('#ajax_view').html(response);
            }
...
<script type="text/javascript">
	...
	//alert(t_id);
            $(".preloader").show();
		$.ajax({
            url: '<?php echo base_url();?>index.php/Class_teacher/get_report_class/' + class_id + '/' + t_id,
            success: function(response)
            {
