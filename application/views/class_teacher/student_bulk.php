...
<div class="main-content col-md-10">
				<div class="main-content-inner">
					...
					<!-- /section:basics/content.breadcrumbs -->
                        ...
                        <?php echo form_open(base_url() . 'index.php/class_teacher/student_bulk1/add_bulk_student' , array('class' => 'form-inline validate'));?>
...
<script type="text/javascript">
  function check_phone_number(phone)
  {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Class_teacher/check_phone_number/' +phone,
            success: function(response)
            {
