...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Class_teacher/sms_send_popup_exam_report_all/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$page_from); ?>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/Class_teacher/sms_send_popup_exam_report_all/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$page_from , 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
       </div>
