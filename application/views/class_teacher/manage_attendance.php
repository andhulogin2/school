...
<?php echo form_open(base_url() . 'index.php/Class_teacher/attendance_selector/'); ?>
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="class_id" class="select2" onchange="select_section(this.value)">
				...
				$classes=$this->db->get_where('class c')->result_array();
                foreach ($classes as $row):
                    ?>
                    <option value="<?php echo $row['class_id']; ?>"
                            <?php if ($class_id == $row['class_id']) echo 'selected'; ?>><?php echo $row['class_name']; ?></option>
                        <?php endforeach; ?>
            </select>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-12">
    <div class="white-box">
        <?php echo form_open(base_url() . 'index.php/Class_teacher/attendance_update/' . $class_id . '/' . $section_id . '/' . $timestamp); ?>
 ...
 <div>
                    ...
                    foreach ($attendance_of_students as $row){
                        ...
                        <tr>
                            ...
                            <td>
                            <div id="class1">
                                 <select class="select2" id="class" name="status_<?php echo $row['attendance_id']; ?>" onchange='Checklate(this.value,this.getAttribute("name"));'>
						...
						<label for="field-2" class="col-sm-3 control-label">Send-Additional Message</label>
		                    <div class="col-sm-5">
                             <label class="switch switch-success"><input type="checkbox"  name="additional_msg" id="additional_msg" value="1"><span></span></label> 
			                  ...
			                  <input type="text" name="message" id="message" value="<?php echo $r['content'];}?>" style="display: none"/>
                              <?php }else
							  {?>
                              <input type="text" name="message" id="message"  value=""  style="display: none"/>
							 <?php } ?>
			                </div>
					</div>
