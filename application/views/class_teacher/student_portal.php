					...
					<!-- /section:basics/content.breadcrumbs -->
						...
						<div class="page-header">
                            ...
                            <div align="right" style="padding-right:10px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/class_teacher/student_view/"  data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                   </div> 
						</div><!-- /.page-header -->
	...
	Student Administration System Software.
               ...
               $student_id= $student_id; 
                  ...
                  'student_id' => $student_id))->row()->class_id;
                           ...
                           $student_portal_model=$this->crud_model->student_portal_data($student_id);//echo $this->db->last_query();
				   ?>
								<div class="col-sm-12">
...
<h3 class="box-title"><?php echo get_phrase('Send Message'); ?></h3>
          <?php echo form_open(base_url() . 'index.php/Class_teacher/individual_message/' .$student_id);?>
...
<button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><?php echo get_phrase('Send'); ?>
    ...
    foreach ($edit_data as $row3){
        ?>
                ...
                <?php echo form_open(base_url() . 'index.php/Class_teacher/update_student/' . $row3['student_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
 ...
 class="form-control" placeholder="<?php echo get_phrase('Roll No'); ?>">
	...
	echo $student_view['name']; ?>" class="form-control" placeholder="<?php echo get_phrase('Name'); ?>">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-12">
                    <select name="class" class="select2"  onchange="return get_class_sections(this.value)">
                              <option value="<?php echo $row['class_id'];?>"><?php echo $this->crud_model->get_class_name($row['class_id']); ?></option>
                              <option value="">[select]</option>

                              <?php $classes = $this->db->get_where('class',array('academic_year'=>$year))->result_array();
...
<script type="text/javascript">
$('.select2').css('width','680px').select2({allowClear:true})
