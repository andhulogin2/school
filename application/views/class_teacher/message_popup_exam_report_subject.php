...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Class_teacher/sms_send_popup_exam_report_subject/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$page_from); ?>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/Class_teacher/sms_send_popup_exam_report_subject/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$page_from, 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
      </div>
                <?php  echo anchor(base_url() . 'index.php/Class_teacher/delete_sms_pop_up/' .$master_id.'/'.$page_from , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        <br /><br /><br />
    </div>
</div>
