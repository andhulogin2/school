									...
									<div class="col-sm-6 infobox-container">
										...
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												...
												$section_id=$this->db->get_where('section' ,array('teacher_id'=>$teacher_id,'academic_year'=>$year))->row()->section_id;
												$this->db->where('e.section_id',$section_id);
												$this->db->where('e.year',$year);
												$this->db->join('student s','s.student_id=e.student_id and s.student_status_id=0');
												$data3=$this->db->get('enroll e')->result_array();
												echo count($data3);
												?></span>
												...
												<div class="widget-main no-padding">
													<table class="table table-bordered" border="1" bordercolordark="#000000">
														...
														<tbody>
														   ...
														   $this->db->join('subject s','s.subject_id=st.subject_id and s.year='.$year,'INNER');
														   $this->db->join('class c','c.class_id=st.class_id','INNER');
														   $this->db->join('section sec','sec.section_id=st.section_id','INNER');
