        	...
        	<div class="main-content col-md-10">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <?php echo form_open_multipart('Class_teacher/add_student', array('class' => 'form-horizontal','id'=>"myform"));?>
            ...
            <input type="text" id="parent" name="parent" placeholder="Parent Name" class="col-xs-10 col-sm-5" />
		                        ...
		                        <select name="section_id" class="select2" required="" id="section_selector_holder">
								  ...
								  <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="phone1" name="phone1" placeholder="Phone number" class="col-xs-10 col-sm-5" required="" onChange="return check_phone_number(this.value)" />
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<div class="input-group input-group-sm">
													<input type="text"  id="mydatepicker"  class="form-control mydatepicker"  name="birthday" />
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="email" name="email" placeholder="Email ID" class="col-xs-10 col-sm-5" />
 											...
 											<input type="hidden" id="id" name="id" placeholder="Email ID" class="col-xs-10 col-sm-5" />
...
<script type="text/javascript">
	...
	get_fee_master(class_id) ;
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Class_teacher/get_class_section/' + class_id ,
...
<script type="text/javascript">
  function check_phone_number(phone1)
  {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Class_teacher/check_phone_number/' +phone1,
            success: function(response)
            {
