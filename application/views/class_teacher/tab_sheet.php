...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php/Class_teacher/tab_sheet');
...
<script type="text/javascript">
	...
	//alert(t_id);
            $(".preloader").show();
		$.ajax({
            url: '<?php echo base_url();?>index.php/Class_teacher/get_report/' + class_id + '/' + t_id,
            success: function(response)
            {
