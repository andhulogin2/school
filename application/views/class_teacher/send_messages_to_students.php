...
<div class="main-content">
            ...
            <?php  echo form_open(base_url() . 'index.php/Class_teacher/teacher_send_messages' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
