													...
													<div class="tab-content padding-4">
														...
														<div id="home2" class="tab-pane in active">
															...
															<div class="scrollable-horizontal" data-size="800">
																<?php echo form_open(base_url() . 'index.php/Class_teacher/new_private_message/');?>
    ...
    <div class="col-md-6">
          <div class="form-group">
					...
					<div class="form-group">
		                ...
		                <select name="section" class="select2" id="section_selector_holder" onChange="return get_student_details(this.value,class.value)">
...
<?php echo form_close(); ?>
    ...
    <div class="col-md-3">
          <div class="form-group">
						...
						<div >
							<select name="class" id="class_selector_holder" class="select2" required="" onChange="return get_class_sections1(this.value)">
                              <option value="">Select</option>
                              <?php	foreach($class as $row): ?>
                            		<option value="<?php echo $row['class_id'];?>"><?php echo $row['class_name'];?></option>
                              <?php endforeach ?>
					...
					<div class="form-group">
						<label for="field-2" class=" control-label">Section</label>
		                    <div >
		                        <select name="section" onChange="get_details1()"  class="select2" id="section_selector_holder1">
...
<div class="row" id="absent">
    ...
    <div id="info4" class="tab-pane">
          ...
          <div class="form-group">
						<label for="field-2" class="control-label"><?php echo get_phrase('Class'); ?></label>
						<div >
							<select name="class" id="class_selector_holder4" class="select2" required="" onChange="return get_class_sections4(this.value)">
					...
					<div class="form-group">
						<label for="field-2" class=" control-label"><?php echo get_phrase('Section'); ?></label>
		                    <div >
		                        <select name="section" onChange="get_details3()"  class="select2" id="section_selector_holder4">
