...
<div class="main_data">
    ...
    <div align="right" style="padding-right:10px">  
                              <a href="<?php echo base_url();?>index.php/Class_teacher/homework_add/"><b><button class="btn-info">Add New</button></b></a> 
 </div> 
...
<table class="table table-bordered datatable">
    ...
    <tr>
        ...
        <th style="text-align: center;" class="table-header" colspan="2"><div>Options</div></th>
    </tr>
</thead>
<tbody>
    <?php
	...
	$this->db->where('uploader_id', $teacher_id);
    ...
    foreach ($homeworks as $row):
        ...
        <tr>
            ...
            <td style="text-align: center;"><a href="<?php echo base_url(); ?>index.php/Class_teacher/homeworkroom/details/<?php echo $row['homework_code'];?>">
                    <?php echo $row['title']; 
					 
					?>
                </a>
            </td>
            <td style="text-align: center;"><span class="badge badge-info badge-roundless"><?php echo $this->crud_model->get_type_name_by_id('class',$row['class_id']);?></span></td><?php /*?><?php echo $row['uploader_id'];?><?php */?>
            <td style="text-align: center;"><?php echo $this->crud_model->get_type_name_by_id('section',$row['section_id']);?></td>
            <td style="text-align: center;"><?php echo "e";?>
            </td>
            <td style="text-align: center;"><?php echo $this->crud_model->get_type_name_by_id('subject',$row['subject_id']);?></td>
           <td style="text-align: center;" class="text-nowrap">
                <a href="<?php echo base_url(); ?>index.php/Class_teacher/homeworkroom/details/<?php echo $row['homework_code']; ?>">
                    <i class="fa fa-edit text-info"></i>
                </a></td>
<td style="text-align: center;" class="text-nowrap">
                <a href="<?php echo base_url(); ?>index.php/Class_teacher/homework/delete/<?php echo $row['homework_code']; ?>">
