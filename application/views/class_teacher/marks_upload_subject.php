        ...
        <div class="form-group">
            ...
            <select name="class_id" class="select2" onchange="get_class_subject(this.value)" >
				...
				$teacher_id=$this->db->get_where('staff' ,array('user_id'=>$admin))->row()->staff_id;
					   ...
					   // $this->db->where('s.teacher_id',$teacher_id);
					$this->db->join('subject s','c.class_id=s.class_id','LEFT');
...
<div class="row" style="padding-left:20px; padding-right:20px">
                <?php echo form_open(base_url() . 'index.php/Class_teacher/marks_update/' . $class_id . '/' . $section_id . '/' . $exam_id . '/' . $subject_id); ?>
