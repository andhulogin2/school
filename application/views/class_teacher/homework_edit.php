    ...
    <div class="col-md-10">
        <div class="panel panel-info">
            ...
            <div style="text-align:right">
            	<a href="<?php echo base_url().'index.php/Class_teacher/homeworkroom/details/'.$row['homework_code']; ?>">Back</a>
            </div>

            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php/Class_teacher/homework/edit/' . $row['homework_code'], array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data')); ?>
