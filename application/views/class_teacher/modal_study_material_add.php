    ...
    <div class="col-md-10">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php/class_teacher/study_material/create/'.$teacher, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
