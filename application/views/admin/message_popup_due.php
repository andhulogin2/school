...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/FeeManagement/sms_send_popup_fee/'.$master_id); ?>
...
<div class="table-responsive">
                    ...
                    foreach ($sms_of_students as $row):
                        ?>
                            ...
                            <td>
                            <textarea name="content[]" style="width:1118px;height:80px;"><?php echo $row['msg_content']?></textarea>
                            <input type='hidden' name='details_id[]' value='<?php echo $row['details_id']?>'  />     
                            </td>
       ...
       <div class="col-md-offset-4 col-md-3">
         <!--  <?php  echo anchor(base_url() . 'index.php/FeeManagement/sms_send_popup_fee/' .$master_id , 'SEND', array('class' => 'btn btn-danger waves-effect waves-light m-r-10'));?>-->
        <button type="submit" class="btn btn-danger waves-effect waves-light m-r-10" formaction="<?php echo base_url().'index.php/FeeManagement/sms_send_popup_fee/'.$master_id; ?>">SEND</button>
        <?php 
        
		$page_from='fee_due';
		if($section_id==''){$section_id=0;} 
		if($due_date_from==''){$due_date_from="0";}
                 echo anchor(base_url() . 'index.php/admin/delete_sms_pop_up/' .$master_id.'/'.$page_from.'/'.$class_id.'/'.$section_id.'/'.$due_date.'/'.$due_date_from.'/'.$dept_id , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
