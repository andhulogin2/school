...
<div class="row">
    ...
    <div class="white-box">
        ...
        <label style="padding-left:40px;"><b>Total Sms Count</b></label>  :  <label><b><?php echo $query1; ?></b></label>
          ...
          <?php echo form_open(base_url() . 'index.php/Hourly_attendance/sms_send_popup_hourly_attendace/'.$master_id); ?>
<div class="table-responsive">
       ...
       <div class="col-md-offset-4 col-md-3">
        ...
        <?php 
                 ...
                 echo anchor(base_url() . 'index.php/Hourly_attendance/delete_sms_pop_up_hourly_attendace/' .$master_id , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
