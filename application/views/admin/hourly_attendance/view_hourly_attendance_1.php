<div class="row">
				   ...
				   ?>
					...
					?>
                       ...
                       <?php //     <td><?php echo $row['6th Hour']; ?></td> 
                            <td>
                            <a class="btn btn-info" name="send" href="<?php echo base_url();?>index.php/Hourly_attendance/student_absent_sms/<?php echo $row['student_id']; ?>/<?php echo $att_date; ?>" onClick="preloader()" >Send SMS</a>
                            </td>
                        </tr>
                    <?php } ?>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-offset-3 col-sm-5">
        <a class="btn btn-info" name="send_all" href="<?php echo base_url();?>index.php/Hourly_attendance/all_student_absent_sms/<?php echo $att_date; ?>" onClick="preloader()" >Send All</a>
    </div>
    </div>
