...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/admin/sms_send_popup_exam_report_subject/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$subject_id); ?>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/admin/sms_send_popup_exam_report_subject/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id, 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
       </div>
		 <div >
                <?php  echo anchor(base_url() . 'index.php/admin/delete_sms_pop_up/' .$master_id , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
