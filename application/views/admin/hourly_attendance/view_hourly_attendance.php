...
*/ ?>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-offset-3 col-sm-5">
        <a class="btn btn-info" name="btnView" onClick="view_attendance_list();send();">View Attendance</a>
...
<script type="text/javascript">
	...
	function view_attendance_list() 
	{
		...
		//alert(branch_id);
    	$.ajax({
        url: '<?php echo base_url();?>index.php/Hourly_attendance/view_attendance_list/' + class_id +'/'+section_id+'/'+att_date+'/'+hour+'/'+branch_id,
            success: function(response)
            {
                jQuery('#show_students_list').html(response);
			}
