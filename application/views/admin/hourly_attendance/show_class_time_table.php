...
<br><br>  
    ...
    <div class="col-sm-9">
			<select  name="class"  onchange="return get_class_sections(this.value)" id="class" class="select2">
				<option value="">Select</option>
                <?php 
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <select name="section_id" class="select2" required="" id="section_id" >
        <option value="">Select</option>
        </select>
    </div>
</div>
 ...
 <br><br>  		  
    ...
    <div class="col-sm-offset-3 col-sm-5">
       <input type="button" class="btn btn-info" name="btnShow" value="Show" onClick="get_time_table();"/>
