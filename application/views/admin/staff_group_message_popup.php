...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Admin/sms_send_popup_fee/'.$master_id); ?>
...
<div class="table-responsive">
											 <table id="simple-table" class="table table-striped table-bordered table-hover sortable">
													...
													<tr>
														...
														<th style="text-align: center;" class="table-header">Staff</th>
                    ...
                    foreach ($sms_of_students as $row):
                        ?>
                            ...
                            <td>
                                <?php echo $this->db->get_where('staff', array('staff_id' => $row['student_id']))->row()->name; ?>
                            </td>
                            <td>
                                <?php echo $row['phone']; ?>
                            </td>
       ...
       <div class="col-md-offset-4 col-md-3">
        <?php  echo anchor(base_url() . 'index.php/Admin/sms_send_popup_fee/' .$master_id , 'SEND', array('class' => 'btn btn-danger waves-effect waves-light m-r-10'));?>
        <?php 
		$page_from='student_group';
                 echo anchor(base_url() . 'index.php/admin/delete_sms_pop_up/' .$master_id.'/'.$page_from , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
