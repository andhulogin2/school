	...
	<div class="main-content-inner">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Issue Certificates</li>
			</ul><!-- /.breadcrumb -->
		...
		<div class="page-content">
		 ...
		 <?php echo form_open_multipart('Admin/certificate_issue', array('class' => 'form-horizontal','id'=>"myform"));?>
...
if ($action=="success")
{
echo "<script>toastr.success('". "Certificates Issued...', {timeOut: 5000})</script>";
}
?>
...
<script type="text/javascript">
	function get_submitted_certificates() {
	...
	if(class_id!='' && section_id!='' && student_id!=''){
		...
		$.ajax({
            url: '<?php echo base_url();?>index.php/Admin/get_submitted_certificates/' + student_id ,
            success: function(response)
            {
