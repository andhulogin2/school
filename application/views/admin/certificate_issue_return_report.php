	...
	<div class="main-content-inner">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Certificates Issue Return Report</li>
			</ul><!-- /.breadcrumb -->
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>Certificates Issue Return Report</h1>
			</div>
			...
			<div class="col-md-2">
				...
				<div class="col-md-2">
					...
					<div class="form-group">
							...
							<input type="text" name="from_date" id="from_date" required class="form-control mydatepicker" value="<?php echo date('d-m-Y');?>" />
						</div>
					</div>
					<div class="col-md-2" style="padding-left:30px">
					<div class="form-group">
							<label class="control-label" style="margin-bottom: 5px;">To Date</label>
							<input type="text" name="to_date" id="to_date" required class="form-control mydatepicker" value="<?php echo date('d-m-Y');?>" />
						</div>
					</div>
...
<script type="text/javascript">
	...
	var to_date			=	$("#to_date").val();
		...
		$.ajax({
            ...
            url: '<?php echo base_url();?>index.php/Admin/certificate_issue_return_data/' + from_date +'/'+ to_date +'/'+ department +'/'+ class_id +'/'+ section_id +'/'+ student_id ,
