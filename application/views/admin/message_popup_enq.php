...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Enquiry_controller/sms_send_popup_fee/'.$master_id.'/enquiry_view'); ?>
        <?php $this->db->select('count(details_id) as student_count');
		...
		?>
        <label class="col-md-offset-5" style="padding-left:40px;"><b>Total Enquiry</b></label>  :<b><?php echo $query; ?></b>
        ...
        <center>
            <button type="submit" class="btn btn-info" id="submit_button" name="enquiry_view_submit" onclick="preloader()">
...
<div class="table-responsive">
                    ...
                    foreach ($sms_of_students as $row):
                        ?>
                            ...
                            <td>
                                <?php echo $this->db->get_where('tbl_enquiry_master',array('enquiry_id'=>$row['student_id']))->row()->first_name; ?>
                            </td>
                            <td>
                                <?php echo $row['phone']; ?>
                            </td>
       ...
       <div class="col-md-offset-4 col-md-3">
        <?php  echo anchor(base_url() . 'index.php/Enquiry_controller/sms_send_popup_fee/' .$master_id.'/enquiry_view' , 'SEND', array('name'=>'enquiry_view_submit','class' => 'btn btn-danger waves-effect waves-light m-r-10'));?>
        <?php 
	
                 echo anchor(base_url() . 'index.php/Enquiry_controller/delete_sms_pop_up/' .$master_id.'/enquiry_view' , 'Delete', array('name'=>'enquiry_view_delete','class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
