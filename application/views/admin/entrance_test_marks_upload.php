                        ...
                        <div class="page-header">
							<h1>
								Student
									...
									Upload Entrance Test Marks
								
							</h1>
						</div>
                        
                         <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/view_entrance_test'; ?>"><b><button class="btn-info">Back</button></b></a></div> 

<?php echo form_open(base_url() . 'index.php/admin/create_entrance_test/upload_marks'); ?>
    ...
    <div id="subject_holder">
       ...
       <div class="col-md-2">
			...
			<label class="control-label" style="margin-bottom: 5px;">Exam<font color="#FF0000">*</font></label>
				<input type="text" name="exam" id="exam" value="<?php echo $this->db->get_where('tbl_entrance_test',array('entrance_test_id'=>$exam_id))->row()->exam_name; ?>" required="" />
			</div>
    </div>
...
<div class="row">
                           ...
                           <?php echo form_open(base_url() . 'index.php/admin/create_entrance_test/update_marks'); ?>
...
<td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="text-align:left">
                        <input type="text" class=" selectboxit " name="remarks" id="remarks" value="<?php $yr=get_running_year(); echo $this->db->get_where('tbl_entrance_test_mark' , array(
					'class_id' => $class_id , 'section_id' => $section_id , 'entrance_test_id' => $exam_id , 'subject_id' => $subject_id , 'year' => $yr))->row()->remarks
				;?>" required=""/>
                    </div>
