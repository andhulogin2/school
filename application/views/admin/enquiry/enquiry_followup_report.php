                        ...
                        <div class="page-header">
							<h1>View
									<i class="ace-icon fa fa-angle-double-right"></i>Follow Up
                                                ...
                                                <div><h3>UP COMING FOLLOW UP</h3></div>
 ...
 <?php error_reporting(0);
     ...
     $counter = 1;
		...
		foreach($query_result as $row1)
		 {
		$a=$this->db->get_where('tbl_enquiry_master',array('enquiry_id'=>$row1['enquiry_id'],'branch_id'=>$this->session->userdata('branch_id'),'dept_id'=>$this->session->userdata('dept_id')))->result_array();
...
<a data-toggle="tooltip" data-placement="top" href="<?php echo base_url();?>index.php/enquiry_controller/view_call_details/<?php echo $row['enquiry_id']?>" title="View Call" data-original-title="View Call"> <span class="green">
 ...
 <?php  echo form_open(base_url() . 'index.php/enquiry_controller/enquiry_upcoming_followup_download/'.$date_from.'/'.$date_to);?>
