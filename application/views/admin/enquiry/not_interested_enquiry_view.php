...
<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
						    ...
						    <li class="active">View Not Interested Enquiry</li>
						</ul>
				    <!-- /.breadcrumb -->
        ...
        <?php  echo form_open(base_url() . 'index.php/enquiry_controller/not_interested_enquiry_view/');?>
...
<a data-toggle="tooltip" data-placement="top" href="<?php echo base_url();?>index.php/enquiry_controller/view_call_details/<?php echo $row['enquiry_id']?>" title="Follow up" data-original-title="Follow up"> <span class="green">
       ...
       &nbsp;&nbsp;&nbsp;
        ...
        <a data-toggle="tooltip" data-placement="top" href="<?php echo base_url();?>index.php/Enquiry_controller/enq_set_interest/<?php   echo $row['enquiry_id']?>/interested" title="Add to Interested list" data-original-title="Add to Interested list"> <span class="green">
         <i class="green ace-icon fa fa-thumbs-up bigger-115"></i> </span>
         </a>
...
<?php echo form_close(); ?>
        <?php  echo form_open(base_url() . 'index.php/enquiry_controller/not_interested_enquiry_download/'.$fdate.'/'.$tdate);?>
