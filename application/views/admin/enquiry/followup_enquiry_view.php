...
<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <div class="page-header">
							<h1>View
									<i class="ace-icon fa fa-angle-double-right"></i>Follow Up
							</h1>
						</div>
                        
                                                <div><h3>TODAYS FOLLOW UP</h3></div>
                                                <div class="main_data">
	<div class="row">
	<div class="col-md-10">
	...
	<thead>
		<tr>
			...
			<th style="text-align: center;"  class="table-header"><div> Call Date </div></th>
 ...
 <?php error_reporting(0);
     ...
     $counter = 1;
		...
		$a=$this->db->get_where('tbl_enquiry_master e',array('enquiry_id'=>$row1['enquiry_id'],'branch_id'=>$this->session->userdata('branch_id'),'dept_id'=>$this->session->userdata('dept_id'),'is_admitted'=>'N','is_deleted'=>'N'))->result_array();
		foreach($a as $row){
		?>
...
<a data-toggle="tooltip" data-placement="top" href="<?php echo base_url();?>index.php/enquiry_controller/view_call_details/<?php echo $row['enquiry_id']?>" title="View Call" data-original-title="View Call"> <span class="green">
  ...
  <?php  echo form_open(base_url() . 'index.php/enquiry_controller/todays_followup_download/') ;?>
 ...
 <?php echo form_close(); ?>
                                                ...
                                                <div><h3>UPCOMING FOLLOW UP</h3></div>

        <?php  echo form_open(base_url() . 'index.php/enquiry_controller/enquiry_followup_report/');?>
