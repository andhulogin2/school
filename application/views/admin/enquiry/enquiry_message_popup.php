...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/Enquiry_controller/sms_send_popup_fee/'.$master_id); ?>
...
<div class="table-responsive">
       ...
       <div class="col-md-offset-4 col-md-3">
        <?php  echo anchor(base_url() . 'index.php/Enquiry_controller/sms_send_popup_fee/' .$master_id , 'SEND', array('class' => 'btn btn-danger waves-effect waves-light m-r-10'));?>
        <?php 
	
                 echo anchor(base_url() . 'index.php/Enquiry_controller/delete_sms_pop_up/' .$master_id , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        </div>
    </div>
</div>
