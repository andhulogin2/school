...
?>
		...
		<?php echo form_open(base_url() . 'index.php/admin/rank_message_individual');?>
<div class="row">
	<div class="col-md-12">
	<div class="white-box">
			...
			?>
				<tr>
					...
					<td style="text-align: center;">
                        ...
                        <input type="hidden" name="subject[]" id="subject[]" value="<?php echo $row['subject_id'];?>" />
					</td>
				<?php
				   $sum=0;
				...
				?>
                 ...
                 <input type="hidden" name="total[]" id="total[]" value="<?php echo $row['total_marks'];?>"/>
                 <input type="hidden" name="mark[]" id="mark[]" value="<?php echo $a;?>"/>
                </td>
                <td style="text-align: center;"><?php 
				if($total_marks =='0'){
				  echo "-";
		...
		<center>
			<a href="<?php echo base_url();?>index.php/admin/tab_sheet_print/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $exam_id;?>" class="btn btn-info">
				<?php echo get_phrase('Print');?>
			</a>
			<button class="btn" type="submit" style="background-color:#009933"  onclick="send_message('<?php echo $class_id;?>','<?php echo $section_id;?>','<?php echo $exam_id;?>','')"> 
