...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/admin/sms_send_popup_progress_report/'.$master_id.'/'.$class_id.'/'.$student_id); ?>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/admin/sms_send_popup_progress_report/'.$master_id.'/'.$class_id.'/'.$student_id, 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
       </div>
		 <div >
