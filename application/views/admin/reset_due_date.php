...
<body>
        	...
        	<div class="main-content">
                ...
                <?php echo form_open(base_url() . 'index.php/feeManagement/get_students_fee_details' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
