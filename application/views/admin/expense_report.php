...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php echo form_open_multipart('Admin/expense_report', array('class' => 'form-horizontal'));?>
             ...
             <tbody>
                      ...
                      foreach($account as $acc):?>
                        <tr>
						   ...
						   ?>
                            <tr><td colspan="7"><font color="#FF0000"><center><b>No Data Found...</b></center></font> </td></tr>
                            <?php } ?>
				</tbody>
            </table>
<?php 
if(count($account)>0){
?>
<div align="center" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Admin/expense_report_excel/'.$branch_id.'/'.$department_id.'/'.$from_date.'/'.$to_date; ?>" ><button class="btn btn-info">Download Excel</button></a>
<a href="<?php echo base_url() . 'index.php/Admin/expense_report_pdf/'.$branch_id.'/'.$department_id.'/'.$from_date.'/'.$to_date; ?>" target="_blank" ><button class="btn btn-info">Download PDF</button></a></div>
