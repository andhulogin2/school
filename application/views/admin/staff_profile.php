...
foreach($profile_info as $row):?>
          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="" style="100%">
              <div class="overlay-box">
                <div class="user-content"><a href="javascript:void(0)"><center><img alt="img" class="thumb-lg img-circle" src="<?php echo $this->crud_model->get_image_url('staff', $row['staff_id']);?>" style="width:100px; height:100"></center></a>
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('staff' , array('staff_id' => $staff_id))->result_array();
                ...
                ?>
                    <?php echo form_open(base_url() . 'index.php/admin/staff_edit/do_update/'.$row2['staff_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
                       ...
                       <input type="hidden" class="form-control" name="user_id" value="<?php echo $row2['user_id'];?>"/>
            ...
            <div class="panel-body">
                   ...
                   $edit_datas = $this->db->get_where('staff' , array('staff_id' => $staff_id))->result_array();
                    foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'index.php/admin/staff_edit/change_password/'.$row3['staff_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
...
<div class="col-md-6">
        <div class="panel" style="border-color:#0099FF">
            ...
            <div class="panel-body">
                  ...
                  //  foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'index.php/Admin/staff_edit/update_username/'.$staff_id, array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Username</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="username" value="<?php echo $this->db->get_where('staff',array('staff_id'=>$staff_id))->row()->username; ?>"/>
                                </div>
                            </div>
