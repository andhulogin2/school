...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php 
		$page="rank";
		echo form_open(base_url() . 'index.php/admin/sms_send_popup_exam_rank/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id); ?>
        ...
        <center>
          ...
          <?php echo form_open(base_url() . 'index.php/admin/sms_send_popup_exam_rank/'.$master_id); ?>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/admin/sms_send_popup_exam_rank/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id , 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
       </div>
		
                <?php  echo anchor(base_url() . 'index.php/admin/delete_sms_pop_up/' .$master_id.'/'.$page , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
                 <br /><br /><br />
                 </div></div></div>
                 </div>
