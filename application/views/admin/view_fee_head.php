				...
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                           ...
                           <div>
                            <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/FeeManagement/add_fee_head/' ?>"><button class="btn-info">Add Fee Item</button></a></div> 
<br>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="table-header"><center>Fee Category</center></th>	
												...
												<tbody>
												 ...
												 foreach($fees as $row1):?>
													<tr>
														...
														<td align="center">
															<?php echo $row1['fee_category_name'];?>
														</td>
                                                        <td align="center">
                                                        <input type="hidden" name="fee_head_id[]" id="fee_head_id[]" value="<?php echo $row1['fee_head_id'];?>"  />
<span name="edit2[]">  <a  name="edit1[]" href="<?php echo base_url();?>index.php/FeeManagement/edit_fee_head/<?php echo $row1['fee_head_id'];?>/<?php echo $class_id;?>" class="btn-sm btn-icon icon-left" ><i name="edit[]" class="fa fa-edit"></i> </a></span>	
 
 &nbsp;&nbsp;&nbsp;
                                                        
 <span name="delete3[]"><a name="delete2[]" href="<?php echo base_url();?>index.php/FeeManagement/delete_fee_heads/<?php echo $row1['fee_head_id'];?>/<?php echo $class_id;?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');"><i name="delete1[]" class="fa fa-close text-danger"></i> </a>	</span>
...
{
echo "<script>toastr.error('". "Failed to Add...', 'Error', {timeOut: 5000})</script>";
}
