...
?>
 <th style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url() . 'index.php/FeeManagement/modify_fees/'.$data['students_fee_master_id']; ?>" target="_blank" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-edit text-info"></i>Modify </a>
