...
<div class="row">
        ...
        <div class="col-md-12">
         <div class="form-group">
               ...
               <input type="password" id="new_password" name="new_password"  class="form-control" style="width:300px;"/>
    </div>
    </div>
     ...
     <div class="col-md-12">
         <div class="form-group">
               ...
               <input type="password" id="confirm_new_password" name="confirm_new_password"  class="form-control" style="width:300px;"/>
    </div>
    </div>
...
if ($action=="success")
{
echo "<script>toastr.success('". "Success...', 'Changed', {timeOut: 5000})</script>";
}
if ($action=="failed")
{
