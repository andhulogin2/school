...
<body>
    ...
    <div align="right" style="padding-right:10px;"><a href="<?php echo base_url() . 'index.php/FeeManagement/bulk_assign_fees1/'.$student_id.'/'.$class_id.'/'.$section.'/back'; ?>"><b><button class="btn-info">Back</button></b></a></div>                                       
