				...
				?>
                           ...
                           <div>
                            <div align="right" style="padding-right:10px">
                            	<a href="<?php echo base_url() . 'index.php/Admin/subjects_view/'; ?>"><button class="btn-info">Back</button></a>&nbsp;&nbsp;
                                <a href="<?php echo base_url() . 'index.php/Admin/new_subject_add/'.$class_id.'/'.$branch_id.'/'.$dept_id; ?>"><button class="btn-info">Add Subject</button></a>
                            </div> 
<br>
                                            ...
                                            <td>
												...
												<table class="table table-bordered">
                                                	<tr>
                                                        ...
                                                        ?>
                                                    <tr>
                                                    	<td style="text-align:left;"><?php echo $sec['name']; ?></td>
                                                        <td style="text-align:left;">
															<?php 
															$this->db->select('teacher_id');
															$this->db->where('subject_id',$row['subject_id']);
															$this->db->where('class_id',$class_id);
															$this->db->where('section_id',$sec['section_id']);
															$teacher_id	=	$this->db->get('subject_teacher')->row()->teacher_id;
                                                            $teacher=$this->db->get_where('staff',array('staff_id'=>$teacher_id));
...
<?php 
				...
				<a href="<?php echo base_url();?>index.php/admin/subject_delete/<?php echo $row['subject_id'];?>/<?php echo $class_id.'/'.$branch_id.'/'.$dept_id;?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');">
