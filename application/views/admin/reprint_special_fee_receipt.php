...
$running_year = get_running_year();?><body>
        	...
        	<div class="main-content">
                ...
                <?php echo form_open(base_url() . 'index.php/feeManagement/reprint_special_fee_receipt1' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
