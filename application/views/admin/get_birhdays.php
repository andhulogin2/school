...
<div align="right"><a href="<?php echo base_url(); ?>index.php/admin/birthday_detail_pdf/<?php echo $date_from; ?>/<?php echo $date_to; ?>"><button type="submit" name="get_pdf" class="btn btn-info">Download PDF</button></a></div>
