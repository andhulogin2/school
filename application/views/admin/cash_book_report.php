...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php echo form_open_multipart('Admin/cash_book_report', array('class' => 'form-horizontal'));?>
...
if(count($account)>0){
?>
 <div align="center" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Admin/cash_book_report_excel/'.$branch_id.'/'.$department_id.'/'.$from_date.'/'.$to_date; ?>" ><button class="btn btn-info">Download Excel</button></a>
<a href="<?php echo base_url() . 'index.php/Admin/cash_book_report_pdf/'.$branch_id.'/'.$department_id.'/'.$from_date.'/'.$to_date; ?>" target="_blank" ><button class="btn btn-info">Download PDF</button></a></div> 
<?php } ?> 
