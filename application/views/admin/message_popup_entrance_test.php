				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Entrance Test Message</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
    ...
    <div class="white-box">
        ...
        <?php echo form_open(base_url() . 'index.php/admin/sms_send_popup_entrance_test/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$subject_id); ?>
		...
		?>
        <label style="padding-left:40px;"><b>Total Sms Count</b></label>  :  <label><b><?php echo $query; ?></b></label>
        </div>
       ...
       <div class="col-md-offset-4 col-md-2">
        <?php  echo anchor(base_url() . 'index.php/admin/sms_send_popup_entrance_test/'.$master_id.'/'.$class_id.'/'.$section_id.'/'.$exam_id.'/'.$subject_id, 'Send Sms', array('class' => 'btn btn-primary waves-effect waves-light m-r-10')); ?>
      </div>
                <?php  echo anchor(base_url() . 'index.php/admin/delete_sms_pop_up/' .$master_id.'/entrance_test' , 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); 
				 echo form_close(); ?>
        <br /><br /><br />
    </div>
</div>
