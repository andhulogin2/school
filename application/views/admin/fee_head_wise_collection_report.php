			...
			<div class="col-md-2">
				...
				{?>
					...
					<div class="form-group">
							...
							<select name="section_id" id="section_id" class="select2" disabled="disabled" >
								<option value="">Select</option>		
							</select>
						</div>
					</div>
...
<script type="text/javascript">
	...
	var to_date			=	$("#to_date").val();
		...
		$.ajax({
            ...
            url: '<?php echo base_url();?>index.php/FeeManagement/get_fee_head_wise_report/' + from_date +'/'+ to_date +'/'+  department +'/'+ class_id +'/'+ section_id ,
