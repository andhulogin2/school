 ...
 <?php $running_year = get_running_year();?>
                       ...
                       <div class="row col-md-10"><font color="#FFFFFF">fdzffd</font></div>
                           ...
                           <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/admin/students_area/<?php echo $cls;?>"  data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                   </div> 
						</div>
            ...
            <?php
            $yr=get_running_year();
    $student_info = $this->db->get_where('enroll', array('student_id' => $student_id, 'year' => $yr))->result_array();
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control" name="student_session">
                            <?php
                            $sess=$student_view['student_session'];
                            ?>
...
<!--<td style="text-align: center;"><a href="<?php echo base_url();?>index.php/admin/mark_message_bulk/<?php echo $class_id;?>/<?php echo $sec_id;?>/<?php echo $student_id;?>/<?php echo $row2['exam_id'];?>" class="btn btn-info">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-md-10">
...
<?php */?>				 
             ...
             <td style="text-align: center;"><a href="<?php echo base_url();?>index.php/admin/attendance_message/<?php echo $class_id;?>/<?php echo $sec_id;?>/<?php echo $student_id;?>/<?php echo $present;?>/<?php echo $total;?>/<?php echo $perc;?>/<?php echo $ma->mnth;?>" class="btn btn-info" target="_blank">
				<font color="#FFFFFF"><?php echo get_phrase('Send SMS');?></font></a></td>
...
<script src="http://code.jquery.com/ui/1.11.0/jquery-ui.js"></script>                                                           
  <script type="text/javascript">
	...
	</script>   <script src="http://code.jquery.com/jquery-1.9.1.js"></script>
<script src="http://code.jquery.com/ui/1.11.0/jquery-ui.js"></script>                                                           
  <script type="text/javascript">
    $(document).ready(function () {
        $('.mydatepicker').datepicker({
