...
<table class="table sortable simple-table table-bordered table-hover">
	...
	<tr>
    	...
    	<th class="table-header">Class&nbsp;&nbsp;<i class="fa fa-sort" aria-hidden="true" title="Sort By Class"></i></th>
        <?php
	...
	<tr>
    	...
    	<td><?php echo $data['notes']; ?>&nbsp;&nbsp;&nbsp;
        	<a href="#" onClick="editNoteModal('<?php echo $data['students_group_details_id']; ?>','<?php echo trim($data['notes']); ?>','<?php echo $students_group_master_id; ?>','<?php echo $this->session->userdata('branch_id');?>','<?php echo $this->session->userdata('dept_id');?>')"><i class="fa fa-edit"></i>
			<?php
			if($data['notes']!='')
			{
			?>
    	...
    	<td><?php echo get_student_phone1($data['student_id']); ?></td>
...
<div id="myModal" class="modal">
	...
	<div class="modal-content">
		<?php echo form_open('admin/group_note_update'); ?>
