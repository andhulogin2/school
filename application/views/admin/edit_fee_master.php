...
<body>
         ...
         <div><div>               
      <div align="right" style="padding-right:10px;"><a href="<?php echo  base_url();?>index.php/FeeManagement/fee_master"><button class="btn-info">Back</button></a></div>       
...
<div class="form-group">
    ...
    <div class="col-sm-9">
  	  <input type="text"  class="col-xs-10 col-sm-5"  id="fee_master_name" name="fee_master_name" value="<?php echo $row['fee_master_name'];?>" />
    </div>
</div>
<br /><br />
<div class="form-group">
...
$query= $this->db->query("select fee_head_id,fee_head from tbl_fee_heads where is_deleted='N'");
$total = 0;
$i=1;
...
<td>
<input type="number" name="fee_details1[]" id="fee_details1[]"  class="col-xs-10 col-sm-5"  min="0" value="<?php echo $amount; ?>" onChange="feeTotal1()" >
</td>
