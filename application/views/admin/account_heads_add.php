...
<div class="col-sm-10 widget-container-col">
                     ...
                     <?php echo form_open('Admin/account_heads_add/', array('class' => 'form-horizontal'));?>
    ...
    <?php } 
         ...
         <input type="hidden" name="account_section" value="<?php echo $this->session->userdata('account_section_id'); ?>" class="form-control"/>
	<?php } ?>
                    ...
                    <div class="col-sm-5">
                      <input type="text" id="account_head" placeholder="Account Head" name="account_head" class="form-control"/>
                    </div>
                  </div>
