							...
							<h1>
								Home Test 
									...
									View
                                        ...
                                        <div></div>
                                        <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/create_home_test/new/'; ?>"><b><button class="btn-info">New Home Test</button></b></a></div> 

                    <?php echo form_open('Admin/view_home_test', array('class' => 'form-horizontal'));
                        $role=$this->session->userdata('role');
						if($role==1 || $role==2)
						{
						 ?>
...
<!-- /.modal-content -->
<td>
<?php  echo anchor('Admin/edit_home_test/'.$row1['home_test_id'].'/'.$row1['class_id'].'/'.$row1['subject_id'].'/'.$row1['section_id'].'/'.$row1['branch_id'].'/'.$row1['dept_id'].'/'.$row1['date_exam'], '<i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>');?>
&nbsp;&nbsp;&nbsp;&nbsp;<?php 
$this->db->where('home_test_id',$row1['home_test_id']);
								$a=$this->db->get('tbl_home_test_mark');
								...
								<a href="<?php echo base_url();?>index.php/admin/create_home_test/delete/<?php echo $row1['home_test_id']?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');">
                            <i class="fa fa-close text-danger"></i>
                    </a>	
		<?php	}					
//echo anchor('Admin/create_exam/delete/'.$row1['exam_id'],'<i class="ace-icon fa fa-trash-o bigger-130"  title="Delete"></i>');}?>
&nbsp;&nbsp;&nbsp;<?php echo anchor('Admin/home_test_report/'.$row1['class_id'].'/'.$row1['section_id'].'/'.$row1['home_test_id'].'/'.$row1['subject_id'],'<i class="fa fa-bars" aria-hidden="true"  title="Report">&nbsp;&nbsp;Report</i>');?>
</td>
