							...
							<h1>
								...
								<small>
									...
									Assign Fees
                                        ...
                                        <div></div>
<?php
	$flag=$this->session->flashdata('counter');
	if($flag==1)
	{
		$counter=$flag;
	}
...
<div align="right" style="padding-right:50px;"><a href="<?php echo base_url() . 'index.php/FeeManagement/bulk_assign_fees/assign'; ?>"><b><button class="btn-info">Back</button></b></a></div> 
	...
	//$counter=0;
	?> 
<div align="right" style="padding-right:50px;"><a href="<?php echo base_url() . 'index.php/FeeManagement/bulk_assign_fees/assigned'; ?>"><b><button class="btn-info">Back</button></b></a></div> 
    <?php
	}
?>                                        
<br/>
			 ...
			 foreach($fee_master as $fee)
			 {
			  ...
			  ?>
				 ...
				 if($role_id==1 || $role_id==2)
					{
					?>
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/view_students_fee_schedule/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'].'/'.$department_id.'/'.$branch_id ;	 ?>" >
                     <i class="fa fa-eye" aria-hidden="true" title="View Fee Schedule"></i></a>
                     </td>
                       <td>
                     
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/students_payment_details/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'].'/'.$department_id.'/'.$branch_id ;	 ?>" >
                    ...
                    <td> 
                     ...
                     <a href="<?php echo base_url() . 'index.php/FeeManagement/reassign_student_fees/'.$class_id.'/'. $row['section_id'] .'/'. $row['student_id'].'/'.$department_id.'/'.$branch_id ;	 ?>" >
					...
					{
					?>
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/view_students_fee_schedule/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'].'/'.$department_id ;	 ?>" >
                     <i class="fa fa-eye" aria-hidden="true" title="View Fee Schedule"></i></a>
                     </td>
                       <td>
                     
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/students_payment_details/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'].'/'.$department_id ;	 ?>" >
                     <i class="fa fa-money" aria-hidden="true" title="View Payment Details"></i> </a>
                     </td>
                    ...
                    <td> 
                     ...
                     <a href="<?php echo base_url() . 'index.php/FeeManagement/reassign_student_fees/'.$class_id.'/'. $row['section_id'] .'/'. $row['student_id'].'/'.$department_id ;	 ?>" >
                    <i class="fa fa-calendar" aria-hidden="true" title="Reset Due Date"></i></a>
                    <?php
					}
					if($role_id==4 || $role_id==12)
					{
					?>
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/view_students_fee_schedule/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'] ;	 ?>" >
                     <i class="fa fa-eye" aria-hidden="true" title="View Fee Schedule"></i></a>
                     </td>
                       <td>
                     
                    <a href="<?php echo base_url() . 'index.php/FeeManagement/students_payment_details/'. $row['student_id'].'/'.$class_id .'/' .$row['section_id'] ;	 ?>" >
                     <i class="fa fa-money" aria-hidden="true" title="View Payment Details"></i> </a>
                     </td>
                    ...
                    <td> 
                     ...
                     <a href="<?php echo base_url() . 'index.php/FeeManagement/reassign_student_fees/'.$class_id.'/'. $row['section_id'] .'/'. $row['student_id'] ;	 ?>" >
                    <i class="fa fa-calendar" aria-hidden="true" title="Reset Due Date"></i></a>
                    <?php
					}
