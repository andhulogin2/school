...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Admin/add_department/'.$branch_id; ?>" ><button class="btn-info">New Department</button></a></div> 
                              <br> 
