...
$role=$this->session->userdata('role');
 ...
 ?><body>
        	<div class="main-content">
                ...
                <?php echo form_open(base_url() . 'index.php/admin/print_students_list1' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<?php $role=$this->session->userdata('role');
			...
			<select name="department" class="select2" id="department" onChange="return get_class(this.value)">
                   ...
                   <div class="form-group">
										...
										<div class="col-sm-9">
									<select name="class[]" id="class" multiple class="select2" required="" onChange="return get_class_sections(this.value)">
                                     <option value="">Select</option>
                          </select>
...
<div class="form-group">
										...
										<div class="col-sm-9">
			<select name="class[]" multiple onChange="get_class_sections(this.value)" id="class1" class="select2">
				<option value="">Select</option>
...
{?>
		...
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Class:<font color="#FF0000">* </font> </label>
        <div class="col-sm-9">
			<select  name="class[]"  onchange="get_class_sections(this.value)" id="class" class="select2" multiple required>
				<option value="">Select</option>
                <?php 
                                                                        $yr=get_running_year();
...
<script type="text/javascript">
	...
	{
		var length = $("#class option:selected").length;
