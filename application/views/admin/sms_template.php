...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div align="right" style="padding-right:10px;padding-bottom:20px"> 
                        <a href="<?php echo base_url();?>index.php/admin/new_sms_template"><button class="btn-info">New Template</button></a>  </div>
