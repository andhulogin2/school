                     ...
                     <?php echo form_open_multipart('Admin/add_student', array('class' => 'form-horizontal','id'=>"myform"));?>
					   ...
					   if($this->session->userdata('role')==1  || $this->session->userdata('role')==2){?>
                              ...
                              <?php }?>
                                    ...
                                    <?php }
									$enq=$this->db->get_where('tbl_enquiry_master',array('enquiry_id'=>$enquiry))->row();?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name :<font color="#FF0000">*</font></label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="Name" class="col-xs-10 col-sm-5" name="name" required="" value="<?php echo $enq->first_name;?>"/>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="admission_no" placeholder="Admission number" class="col-xs-10 col-sm-5" name="admission_no" />
										</div>
									</div>
                                    <?php 
					   ...
					   {?>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Parent Name: </label>

										<div class="col-sm-9">
											<input type="text" id="parent" name="parent" placeholder="Parent Name" class="col-xs-10 col-sm-5" value="<?php echo $enq->parent_name;?>"/>
										</div>
									</div>
  ...
  <?php } ?>	
		                        ...
		                        <select name="section_id" class="col-xs-10 col-sm-9" required="" id="section_selector_holder">
								  ...
								  <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="phone1" name="phone1" placeholder="Phone number" class="col-xs-10 col-sm-5" onChange="return check_phone_number(this.value)" required="" value="<?php echo $enq->phone1;?>"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="phone2" name="phone2" placeholder="Phone number" class="col-xs-10 col-sm-5" value="<?php echo $enq->phone2;?>"/>
                                   ...
                                   <div class="space-4"></div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Fee Structure:</label>
										 ...
										 <div class="col-sm-5">
		                       	 <select name="fee_master" class="col-xs-10 col-sm-9" id="fee_master">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<div class="input-group input-group-sm">
													<input type="text"  id="mydatepicker"  class="form-control mydatepicker"  name="birthday" value="<?php echo $enq->date_of_birth;?>"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" id="sex" name="sex" data-placeholder="Select one">
                                               <option value="<?php echo $enq->sex;?>"><?php echo $enq->sex;?></option>
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="col-xs-10 col-sm-5" id="address" name="address" placeholder="Address"><?php echo $enq->address;?></textarea>
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="email" name="email" placeholder="Email ID" class="col-xs-10 col-sm-5" value="<?php echo $enq->email;?>"/>
											
										</div>
									</div>
 											<input type="hidden" id="id" name="id" placeholder="Email ID" class="col-xs-10 col-sm-5" value="<?php echo $enq->enquiry_id;?>"/>
...
if ($action=="failed")
{
echo "<script>toastr.success('". "Failed to add...', 'Error', {timeOut: 5000})</script>";
}
