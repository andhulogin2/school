        	...
        	<div class="main-content col-md-10">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <?php echo form_open_multipart('Admin/add_academic_year', array('class' => 'form-horizontal','id'=>"myform"));?>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<div class="input-group input-group-sm">
													<input type="text"  id="mydatepicker"  class="form-control mydatepicker col-xs-10 col-sm-5"  name="start_date" />
...
<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<!-- #section:plugins/date-time.datepicker -->
											<div class="input-group input-group-sm">
													<input type="text"  id="mydatepicker1"  class="form-control mydatepicker col-xs-10 col-sm-5"  name="end_date" />
