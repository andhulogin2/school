...
<div class="main-content col-md-10">
				<div class="main-content-inner">
					...
					<!-- /section:basics/content.breadcrumbs -->
                        ...
                        <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/subjects_view/'; ?>"><b><button class="btn-info">Back</button></b></a></div> 
                        <?php echo form_open(base_url() . 'index.php/Admin/add_subject_bulk' , array('class' => 'form-inline validate'));?>
<br>
  ...
  <?php   if($this->session->userdata('role')==1  || $this->session->userdata('role')==2){?>
	...
	<div class="col-md-3">
		<div class="form_group">
			...
			<select name="class_id" id="class_id" class="select2 selectboxit" required="required"
    ...
    <div class="col-md-4">
		<div class="form_group">
			<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('Class');?></label>
			<select name="class_id" id="class_id" class="select2 selectboxit" required="required"  style="width:80%;"
        ...
        <div id="student_entry">
            <div class="row" style="margin-bottom:10px;">
                ...
                <div class="form-group">
                    <input type="text" name="subject_name[]" id="subject_name" class="form-control" style="width: 260px; margin-left: 5px;"
                        placeholder="<?php echo get_phrase('Subject Name');?>" required>
                </div>
...
<?php echo form_close();?> 
<div class="hr hr32 hr-dotted"></div></div>
<div></div>
</div> <div></div></div>
