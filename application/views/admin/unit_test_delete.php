				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Unit Test Delete</li>
						</ul><!-- /.breadcrumb -->
...
<?php echo form_open(base_url() . 'index.php/admin/delete_unit_test');?>
	<div class="col-md-2">
...
<script type="text/javascript">
	function get_class_subject1(class_id) {
		...
		$.ajax({
            ...
            url: '<?php echo base_url();?>index.php/admin/marks_get_subject1/' + class_id ,
