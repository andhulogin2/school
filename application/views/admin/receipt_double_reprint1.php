							...
							<div class="" >
								<table style="width:100%;padding-top:0px;margin-top:0px;">
									<tr>
										<td style="width:20%;text-align:left;padding-top:0px;margin-top:0px;">
											<img src="<?php echo base_url();?>uploads/logo.png" alt="..."  width="100px" height="auto" style="float:left">
										</td>
								...
								<div style="">
									...
									<table id="simple-table" class="table table-striped table-bordered table-hover"  cellpadding="2" style="padding-top:0px;margin-top:0px;">
										...
										<?php $user_id = $this->db->get_where('tbl_fee_collection_master',array('receipt_number'=>$receipt_number))->row();
										$user_id	=	isset($user_id->collected_by)?$user_id->collected_by:$this->db->get_where('tbl_transport_students_bus_fee_collection_master',array('receipt_number'=>$receipt_number))->row()->entered_by;
										?>
										<tr>
        									<td style="text-align:left;padding-top:2px;padding-bottom:2px;" colspan="2">
												...
												?>
												<!--Total Fee Balance: Rs. <b><?php echo number_format($balance_amount,2); ?></b>.-->
											</td>
										</tr>
									</table>
								</div>
