        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <?php echo form_open('FeeManagement/update_special_fee_heads/', array('class' => 'form-horizontal'));
					 ?>
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="fee_head"  class="col-xs-10 col-sm-5" name="fee_head" required value="<?php echo $fee_heads->fee_head; ?>" />
										</div>
									</div>
                                  
                                    <input type="hidden" id="fee_head_id"  class="col-xs-10 col-sm-5" name="fee_head_id" value="<?php echo $fee_heads->fee_head_id; ?>" >										
...
if ($action=="failed")
{
echo "<script>toastr.error('". "Not Updated...', 'Sorry...', {timeOut: 5000})</script>";
}
?>
