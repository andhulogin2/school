...
<div style="text-align:center">Branch : <?php echo get_branch($branch_id); ?> </div>
<div style="text-align:center">Department : <?php echo get_dept($dept_id); ?></div>
...
<table id="simple-table" class="table table-striped table-bordered table-hover" width="100%" style="border:1px solid;border-collapse:collapse">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border:1px solid"><?php echo $row['class']."/".$row['section']; ?></td>
