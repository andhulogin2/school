	...
	<div class="col-md-4" style="text-align: center;">
		...
		<div class="icon"><i class="entypo-docs"></i></div>
			...
			<h3 style="color: #696969;">
				<?php
					$exam_name  = $this->db->get_where('tbl_home_test' , array('home_test_id' => $exam_id))->row()->exam_name; 
		...
		<table class="table table-bordered">
            ...
            <label>Remark : 
               ...
               <?php 
				...
				$this->db->from('tbl_home_test_mark');
			...
			?>
				...
				<?php $marks = 	$this->db->get_where('tbl_home_test_mark' , array('class_id' => $class_id ,'home_test_id' => $exam_id , 
    ...
    <div class="row">
			...
			<button id="demo2" class="btn btn-yellow" type="submit" style="background-color:#FFFFFF; height:40px"  onclick="send_message1('<?php echo $class_id;?>','<?php echo $section_id;?>','<?php echo $exam_id;?>','<?php echo $subject_id;?>',)"> 
                    ...
                    <br />
                     ...
                     <?php echo form_open(base_url() . 'index.php/admin/hometest_print_report/'.$class_id.'/'.$section_id.'/'.$exam_id);?>
...
$.blockUI({ css: { 
	...
	$.ajax({
	    ...
	    url: '<?php echo base_url();?>index.php/admin/home_test_message/' + class_id + '/' + section_id + '/' + exam_id + '/' + subject_id + '/' +
