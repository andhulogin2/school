...
<div class="col-sm-10 widget-container-col">
                              <div align="right" style="padding-right:230px"><a href="<?php echo base_url();?>index.php/Admin/view_exam/" data-dismiss="fileinput"><button class="btn-info"> Back</button></a> </div>
...
<div class="form-group">
										...
										<div class="col-sm-5">
			<select name="class" class="select2" onchange="select_section(this.value)" id="class1" class="select2">
				<option value="">Select</option>
...
{?>
		...
		<label class="col-sm-4 control-label no-padding-right" for="form-field-1-1">Class:<font color="#FF0000">* </font> </label>
        <div class="col-sm-5">
			<select  name="class" class="form-control selectboxit" onchange="select_section(this.value)" id="class" class="select2">
				<option value="">Select</option>
                <?php 
    ...
    <?php }?>
		     		 <div class="form-group">
                    <label class="col-sm-4 control-label">Exam Name<font color="#FF0000">* </font></label>
                    <div class="col-sm-5">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control"  name="comment" placeholder="Description" class="col-xs-12 col-sm-12">
                  </div>
                            </div>
