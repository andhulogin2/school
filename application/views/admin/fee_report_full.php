        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<?php echo form_open(base_url() . 'index.php/feeManagement/fee_report_per_year1' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
						...
						?>      
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select any one</label>
								<div class="col-sm-9">
								<input type="radio" name="report_option" id="report_option" value="only_current_year_due" > Show current year due only<br>
								<input type="radio" name="report_option" id="report_option" value="only_last_year_due" > Show last year due only<br>
								<input type="radio" name="report_option" id="report_option" value="both" checked > Both last year due and current year due
							</div>
						</div>
