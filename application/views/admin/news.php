...
<div class="main_data">
	<div class="row">
	<div class="col-md-12">
		<div align="right" style="padding-right:10px;padding-bottom:10px;"><a href="<?php echo base_url() . 'index.php/Admin/news_add'; ?>"><b><button class="btn-info">Add News</button></b></a></div> 
	<div class="white-box">
	...
	<tbody>
     ...
     $counter = 1;
		...
		$this->db->where('news.academic_year',$running_year);
    ...
    <td style="text-align: center;">
			<?php echo date('d-m-Y',strtotime($row['news_status']));?>
    </td>
