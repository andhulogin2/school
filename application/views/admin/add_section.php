...
?>
            ...
            <div class="row">
            			...
            			<div align="right" style="padding-bottom:10px;padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/view_section_add/'.$class_id; ?>"><button class="btn-info">Add Section</button></a> <a href="<?php echo base_url() . 'index.php/Admin/view_section_add_bulk'; ?>"><button class="btn-info">Add Bulk Section</button></a></div> 							
...
<?php 
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												  ...
												  $q=$this->db->get_where('section',array('class_id'=>$class_id,'academic_year'=>$academic_year))->result_array();
												  foreach($q as $data):?>
													<tr>
