...
<div class="row">
    ...
    <div class="white-box">
		...
		?>
        <label class="col-md-offset-5" style="padding-left:40px;"><b>Total Staff</b></label>  :<b><?php echo $query; ?></b>
...
<div class="table-responsive">
                    ...
                    $sms_of_staffs = $this->db->get_where('tbl_sms_delivery_details', array('sms_master_id' => $master_id))->result_array();
						//echo "<pre>";	print_r($sms_of_staffs); echo "</pre>";
                    foreach ($sms_of_staffs as $row):
                        ?>
