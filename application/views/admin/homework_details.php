...
<div class="col-md-7">
    <div class="panel panel-info">
            ...
            <font color="#FFFFFF">Details</font></div> 
        </div>
...
<div class="col-md-3">
    <div class="panel panel-warning" data-collapsed="0">
        ...
        $students   =   $this->db->get_where('enroll e' , array('e.class_id' => $row['class_id'], 'e.section_id' => $row['section_id'] , 'e.year' => $running_year))->result_array();
