        ...
        <br/> <br/>
       <div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Library/add_new_book/'; ?>"><button class="btn-info">New Book</button></a></div> 
 <br />
...
{
if($book['is_available']=='N') 
{ 
?>
<tr id="row<?php echo $book['book_master_id']?>"> <td  style="text-align: center;"> <?php echo $i; ?> </td> 
<td  style="text-align: center;" id="book_number<?php echo $book['book_master_id']?>"> <b><font color="#FF0000"><?php if( $book['book_number']==null) echo '-'; else echo $book['book_number'];?>  </font></b> </td> 
<td  style="text-align: center;" id="book_name<?php echo $book['book_master_id']?>"> <b><font color="#FF0000"><?php if( $book['book_name']==null) echo '-'; else echo $book['book_name'];?>  </font></b>   </td> 
<td  style="text-align: center;" id="book_category_name<?php echo $book['book_master_id']?>"> <b><font color="#FF0000"><?php if( $book['book_category_name']==null) echo '-'; else echo $book['book_category_name'];?>  </font></b></td> 
<td  style="text-align: center;" id="book_stream_name<?php echo $book['book_master_id']?>"> <b><font color="#FF0000"> <?php if( $book['book_stream_name']==null) echo '-'; else echo $book['book_stream_name'];?>  </font></b> </td> 
<td  style="text-align: center;" id="book_language_name<?php echo $book['book_master_id']?>"> <b><font color="#FF0000"> <?php if( $book['book_language_name']==null) echo '-'; else echo $book['book_language_name'];?>  </font> </td>

<td id="<?php echo $book['book_master_id']?>">
<span class="red" id="status" style="width:500px" > <b> <font color="#FF0000"> NOT AVAILABLE </font> </b> </span>
</td>

<td style="text-align:center;" > 

			<a href="#" id="edit_inline<?php echo $book['book_master_id'];?>"  class="tooltip-success" data-rel="tooltip" title="Edit" onClick="showEdit(<?php echo $book['book_master_id'];?>);">
              <span class="blue"><i class="ace-icon fa fa-pencil bigger-120"></i></span></a>
              
              <a href="#" id="save_inline<?php echo $book['book_master_id']?>" style="display:none;" class="tooltip-success" data-rel="tooltip" title="Save" onClick="saveBook(<?php echo $book['book_master_id']; ?>)">
...
<td  style="text-align: center;" id="book_stream_name<?php echo $book['book_master_id']?>"> <?php if( $book['book_stream_name']==null) echo '-'; else echo $book['book_stream_name'];?>  </td> 
...
<td id="<?php echo $book['book_master_id']?>">
<span class="red" id="status" style="width:500px" > <b> <font color="#006600"> AVAILABLE </font> </b>  </span>
</td>
