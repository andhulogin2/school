...
<div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Transport_management/view_student_bus_fee_pay/'; ?>"><button class="btn-info">Choose Another</button></a></div>
...
<script type="text/javascript">	
 function get_details(){
	 jQuery('#payment').html("");
       ...
       $.ajax({
	    url: '<?php echo base_url();?>index.php/Transport_management/student_payment_details/' + classid + '/' + section + '/' + branch_id  ,
            success: function(response)
            {
