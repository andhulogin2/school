							...
							<h1>
                             ...
                             <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/Transport_management/view_vehicle_ownership/<?php echo $ownership_type_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                    ...
                                    <div>
                     <?php echo form_open('Transport_management/vehicle_ownership_add/', array('class' => 'form-horizontal'));?>
					 
										<center><div class="widget-box" style="width:420px">
											<div class="widget-header">
												<h4><font color="#FFFFFF">New Ownership</font></h4>
											</div>
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<form>
														<!-- <legend>Form</legend> -->
														<fieldset><br>
															<center><label>Vehicle Ownership</label></center>
                                                           
                                                            
															<center><input type="text" id="ownership_type" placeholder="ownership_type" name="ownership_type" /></center> 
...
<script>
	...
	//alert(class_id);
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Transport_management/view_vehicle_ownership/' ,
