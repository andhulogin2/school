				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Bus Fee Concession</li>
						</ul><!-- /.breadcrumb -->
...
<div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Transport_management/view_bus_fee_concession/'; ?>"><button class="btn-info">Choose Another</button></a></div>
...
<script type="text/javascript">	
 function get_details(){
	 jQuery('#payment').html("");
       ...
       $.ajax({
	    url: '<?php echo base_url();?>index.php/Transport_management/get_student_details/' + classid + '/' + section  ,
            success: function(response)
            {
