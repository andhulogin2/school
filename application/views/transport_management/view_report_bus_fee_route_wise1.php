...
<body>
        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div align="right"><a href="<?php echo base_url();?>index.php/Transport_management/bus_fee_route_wise"><b><button class="btn-info">Back</button></b></a> &nbsp;<a href="<?php echo base_url();?>index.php/Transport_management/bus_fee_route_wise_excel"><button class="btn-info">Download Excel</button></a></div>
<br/>
 <?php
...
<label><b>Route : &nbsp <?php echo $row['route_master_name']; ?></b></label>
