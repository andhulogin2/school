        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <?php 
                                   echo form_open_multipart('Transport_management/employee_master_add', array('class' => 'form-horizontal','id'=>"myform"));?>
								...
								<!-- PAGE CONTENT BEGINS -->
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="first_name" placeholder="First Name" class="col-xs-10 col-sm-5" name="first_name" required />
										</div>
									</div>
                                    ...
                                    <div class="form-group" id="branch_role">
										...
										<div class="col-sm-9">
											<input type="text" id="last_name" placeholder="Last Name" class="col-xs-10 col-sm-5" name="last_name" />
										</div>
									</div>
                                    ...
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<input type="text" id="house_name" placeholder="House Name" class="col-xs-10 col-sm-5" name="house_name" />
										</div>
									</div>
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<input type="text" id="post" placeholder="Post" class="col-xs-10 col-sm-5" name="post" />
										</div>
									</div>
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<textarea id="address" placeholder="Address" class="col-xs-10 col-sm-5" name="address" ></textarea>
										</div>
									</div>
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<input type="text" id="date_of_birth" placeholder="Date of Birth" class="col-xs-10 col-sm-5" name="date_of_birth" />
										</div>
									</div>
                                    <div class="form-group" >
							  ...
							  foreach ($marital_status as $status)
							  				{
											   ...
											   ?>
                                               <option value="<?php echo $status['marital_status_id']?>"><?php echo $status['marital_status']; ?></option>
                                               <?php
											}
											   ?>
                                    ...
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<select name="employee_designation_id" class="select2" id="employee_designation_id" required >
                              					<option value="">Select</option>
                              <?php 
							  foreach ($employee_designation as $designation)
							  				{
											   ...
											   ?>
                                               <option value="<?php echo $designation['employee_designation_id']?>"><?php echo $designation['employee_designation']; ?></option>
                                               <?php
											}
											   ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="licence_number" name="licence_number" placeholder="Licence Number" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="badge_number" name="badge_number" placeholder="Badge Number" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="licence_details" name="licence_details" placeholder="Licence Details" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="date_of_joining" name="date_of_joining" placeholder="Date of Joining" class="col-xs-10 col-sm-5" />
