							...
							<h1>
                             ...
                             <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/Transport_management/view_vehicle_class/<?php echo $vehicle_class_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                    ...
                                    <div>
                     <?php echo form_open('Transport_management/vehicle_class_add/', array('class' => 'form-horizontal'));?>
					 
										<center><div class="widget-box" style="width:420px">
											<div class="widget-header">
												<h4><font color="#FFFFFF">New Vehicle Class</font></h4>
											</div>
												...
												<div class="widget-main no-padding">
													<form>
														...
														<fieldset><br>
															...
															<center><input type="text" id="vehicle_class_name" placeholder="Vehicle Class" name="vehicle_class_name" /></center> 
