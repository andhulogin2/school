				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Bus Fee Due</li>
						</ul><!-- /.breadcrumb -->
							...
							<h1>
								Report 
									...
									Bus Fee Due Report
                                        ...
                                        <div></div>
<?php echo form_open(base_url() . 'index.php/Transport_management/view_bus_fee_due_report1',array('class'=>'form-horizontal form-groups-bordered validate', 'enctype'=>'multipart/form-data'));?>
                 ...
                 <div class="form-group">
                              ...
                              <?php }?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
			<select name="department" class="select2" id="department" required onChange="return get_class(this.value)">
                              <option value="">Select</option>
...
<div class="form-group">
    ...
    <font color="#FF0000">*</font></label>
        <div class="col-sm-9">
             <input type="text" id="due_date" name="due_date" class="select2 mydatepicker" required="" value="<?php echo date('d-m-Y'); ?>"/>
        </div>
</div>
