				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add Vehicle Maintenance Log</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
                        ...
                        <div class="page-header">
                            ...
                            <div align="right" style="padding-right:100px"> 
                              <a href="<?php echo base_url();?>index.php/Transport_management/view_vehicle_maintenance_log_book/<?php echo $vehicle_master_id; ?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                   </div> 
						</div><!-- /.page-header -->

                     <?php 
                                   echo form_open_multipart('Transport_management/vehicle_maintenance_log_book_add', array('class' => 'form-horizontal','id'=>"myform"));?>
								...
								<!-- PAGE CONTENT BEGINS -->
                                    ...
                                    <div class="form-group" id="branch_role">
										...
										<div class="col-sm-9">
											<input type="text" id="date_of_entry" placeholder="Date of Entry" class="col-xs-10 col-sm-5" name="date_of_entry" required />
										</div>
									</div>
                                    ...
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<input type="text" id="maintenance_work_done" placeholder="Maintenance Work Done"  class="col-xs-10 col-sm-5" name="maintenance_work_done" required />
										</div>
									</div>
                                    ...
                                    <div class="form-group" >
										...
										<div class="col-sm-9">
											<input type="text" id="maintenance_work_done_from" placeholder="Maintenance Work Done From"  class="col-xs-10 col-sm-5" name="maintenance_work_done_from" required />
										</div>
									</div>
                                      
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Maintenance Work Cost :<font color="#FF0000">*</font></label>

										<div class="col-sm-9">
											<input type="text" id="maintenance_work_cost" placeholder="Maintenance Work Cost" onkeyUp="allDecimals(this)"   class="col-xs-10 col-sm-5" name="maintenance_work_cost" required />
										</div>
									</div>
...
function allLetter(maintenance_work_done)
{ 

var letters = /^[A-Z a-z]+$/;                               
if(maintenance_work_done.value.match(letters))
{
return true;
}
else
...
return false;
 ...
 function allLetter1(maintenance_work_done_from)
{ 

var letters = /^[A-Z a-z]+$/;                               
if(maintenance_work_done_from.value.match(letters))
{
return true;
}
else
