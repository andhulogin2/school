				...
				<div class="main-content-inner">
                    ...
                    <div class="page-content"> 
                        ...
                        <div align="right"> 
                              ...
                              &nbsp;
                               <a href="<?php echo base_url() . 'index.php/Transport_management/add_vehicle_route_register/'.$route_master_id; ?>" ><button class="btn-info">New Entry</button></a>
                              &nbsp;
                               <a href="<?php echo base_url() . 'index.php/Transport_management/add_vehicle_route_register_bulk/'.$route_master_id; ?>" ><button class="btn-info">Bulk Entry</button></a>
           ...
           <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="width:100%">
												<thead>
													<tr>
														...
														<th class="table-header"><center>Driver Name</center></th>
                                                        <th class="table-header"><center>Conductor Name</center></th>
                                                        <th class="table-header"><center>Cleaner Name</center></th>
             ...
             <tbody>
											...
											<td><center><?php echo $vehicle['bus_number'];?></center></td>
											<td><center><?php echo $vehicle['driver_name'];?></center></td>
									<td><center><?php echo $vehicle['conductor_name'];?></center></td>
                                       <td><center><?php echo $vehicle['cleaner_name'];?></center></td>			
														<td><center><?php echo $vehicle['branch_name'];?></center></td>
                                                        
                                                        <td>
															<?php
                											echo anchor('Transport_management/vehicle_route_register_edit/' .$vehicle['route_register_id'].'/'.$route_master_id, '<i class="fa fa-edit text-info"  title="Edit"></i>');
                											?>
					</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
															<a href="<?php echo base_url();?>index.php/Transport_management/vehicle_route_register_delete/<?php echo $vehicle['route_register_id']?>/<?php echo $vehicle['route_master_id']?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');">
...
if ($action=="Inserted")
{
echo "<script>toastr.success('". "Vehicle route register inserted successfully...', 'Inserted', {timeOut: 5000})</script>";
}
else if($action=="Not_inserted")
{
echo "<script>toastr.error('". "Insertion failed...', 'Not Added', {timeOut: 5000})</script>";
}
