...
<body>
        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div align="right"><a href="<?php echo base_url();?>index.php/Transport_management/bus_fee_bus_wise"><b> <button class="btn-info">Back</button></b></a></div>
<br/>         
<label><b>Bus Number : <?php echo $bus_number; ?></b></label>		<br>
<label><b>Route Name : <?php echo $route_master_name; ?></b></label>
<a href="<?php echo base_url();?>index.php/Transport_management/bus_fee_bus_wise_excel"><button style="float:right" class="btn-info">Download</button></a>
