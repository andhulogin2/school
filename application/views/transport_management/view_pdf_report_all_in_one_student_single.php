<head>
	<title>STUDENT'S TRANSPORTAION REPORT</title>
</head>
<body>
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <div style="text-align:center"><span><h2>STUDENT'S TRANSPORTAION REPORT</h2></span></div>
                <br/> 
                ...
                <thead style="border:1px solid">
                    <?php
						...
						foreach($result as $value):
							...
							{
							?>
                    	<tr style="background:#66b3ff;border:1px solid">
                            ...
                            <th class='table-header'><button type="button" class="btn-info download_single" style="float:right" class="btn-info">Download</button></th>
						</tr>
