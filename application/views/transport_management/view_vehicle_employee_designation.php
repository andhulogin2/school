...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Transport_management/add_vehicle_class/'.$branch_id; ?>" >New Vehicle Class</a></div> 
                              <br> 
												  ...
												  foreach($log as $vehicle):?>
													<tr>
														...
														<td>
																...
																<?php
                echo anchor('Transport_management/vehicle_class_edit/' .$vehicle['vehicle_class_id'].'/'.$vehicle['vehicle_class_name'], '<i class="fa fa-edit text-info"></i>');
                ?>
					</div></td><td >	
