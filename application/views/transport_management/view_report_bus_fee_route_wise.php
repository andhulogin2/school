							...
							<h1>
								Report 
									...
									Route Wise Report
                                        ...
                                        <div></div>
<?php echo form_open(base_url() . 'index.php/Transport_management/get_bus_fee_route_wise',array('class'=>'form-horizontal form-groups-bordered validate', 'enctype'=>'multipart/form-data'));?>
...
{?>
                                    <div class="form-group" id="branch_role">
										...
										<div class="col-sm-9">
											<select name="branch_id" class="select2" id="branch_id" required onChange="return get_route(this.value)">
                              ...
                              <?php }?>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Route:<font color="#FF0000">*</font></label>

										<div class="col-sm-9">
											<select name="route_master_id" class="select2" id="route_master_id" required >
                                    ...
                                    <div class="form-group" id="dept_role">
										...
										<div class="col-sm-9">
											<select name="route_master_id" class="select2" id="route_master_id" required >
												...
												?>
                                                <option value="<?php echo $route1['route_master_id'] ?>"><?php echo $route1['route_master_name'] ?></option>
                                                <?php 
												endforeach;
												?>
                          					</select>
