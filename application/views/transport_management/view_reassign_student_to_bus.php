				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Reassign Students</li>
						</ul><!-- /.breadcrumb -->
...
<div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/Transport_management/view_reassign_student_to_bus/'; ?>">Choose Another</a></div>
