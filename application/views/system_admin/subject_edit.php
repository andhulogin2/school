...
<body>
        	...
        	<div class="main-content">
				<div class="main-content-inner">
				 ...
				 <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/view_subject/'.$subject_id; ?>">Back</a></div> 

                     
                     <?php echo form_open('Admin/update_subject/'.$class_id, array('class' => 'form-horizontal'));?>
