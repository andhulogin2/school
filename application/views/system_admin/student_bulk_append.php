...
<div class="row">
	...
	<div class="col-md-2">
		<div class="form_group">
			<?php /*?><select name="parent_id[]" id="parent_id_<?php echo $total;?>" class="form-control selectboxit">
              ...
              <input type="text" class="form-control" name="parent[]" id="parent_<?php echo $total;?>" placeholder="<?php echo get_phrase('Parent Name');?>">
		</div>
	</div>
