                     ...
                     <?php echo form_open_multipart('Admin/add_student', array('class' => 'form-horizontal','id'=>"myform"));?>
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="Name" class="col-xs-10 col-sm-5" name="name" required="" value="<?php echo $q->first_name." ".$q->last_name;?>"/>
										</div>
									</div>
                                    <?php 
					   ...
					   {?>
                                    ...
                                    <?php $cls=$this->db->get_where('class',array('class_id'=>$q->course_enquired))->row()->name;?>
                              <option value="<?php echo $q->course_enquired;?>"><?php echo $cls;?></option>
							  ...
							  ?>
		                        ...
		                        <select name="section_id" class="col-xs-10 col-sm-9" required="" id="section_selector_holder">
								  ...
								  <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="phone1" name="phone1" placeholder="Phone number" class="col-xs-10 col-sm-5" required="" value="<?php echo $q->phone1;?>"/>
