...
<div class="main-content">
    ...
    <td><?php echo $row['remark'];?></td>
        ...
        <a href="php echo base_url();?>index.php/enquiry_controller/delete_call/<?php echo $row['call_id'] ?>" data-toggle="tooltip"  data-placement="top" title="Delete" data-original-title="Delete"> <span class="red">
