...
<tr>
   ...
   <td><?php echo $this->db->get_where('settings' , array('type' =>'currency'))->row()->description;?><?php echo $row['salary'];?></td>
   <td><?php echo $row['phone'];?></td>
              
   <td><?php echo $row['email'];?></td>
  <td> &nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/admin/teacher_profile/<?php echo $row['teacher_id'];?>" data-toggle="tooltip" title="View Profile"> <i class="fa fa-user text-inverse m-r-10"></i></a>&nbsp;&nbsp;&nbsp;
               <a href="<?php echo base_url();?>index.php/admin/teacher_edit/delete/<?php echo $row['teacher_id'];?>" data-toggle="tooltip" title="Delete"> <i class="fa fa-close text-danger"></i> </a>
   </td>
</tr>
