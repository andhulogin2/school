...
<span class="input-icon">
					...
					<!-- /section:basics/content.breadcrumbs -->
                        ...
                        <div align="right" style="padding-right:100px"> 
                           <a href="<?php echo base_url();?>index.php/enquiry_controller/enquiry_view/"><b><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Back				                      </b></a> 
                            </div>
                        </div><!-- /.page-header -->
						...
						<div class="form-group">
								   ...
								   <i class="ace-icon fa fa-calendar"></i>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" id="sex" name="sex" value="<?php echo $row->sex;?>">
...
<?php }endforeach;?>               
                    ...
                    <input type="text" id="email" value="<?php echo $row->email;?>" class="col-xs-10 col-sm-5" name="email" />
                        ...
                        ?>
                                    ...
                                    <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Highest Qualification :</label>
                                    <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Instituation:</label>
                                    <div class="col-sm-9">
