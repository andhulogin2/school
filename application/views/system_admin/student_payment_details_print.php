...
?>
 <th style="text-align: center;" class="text-nowrap"><a href="#" data-toggle="tooltip" onclick="showAjaxModal('<?php echo $url;?>')" data-original-title="Edit"> <i class="fa fa-edit text-info"></i>view </a>
...
<div class="col-sm-9">
<input type="text" class="col-xs-10 col-sm-5" name="txtreceipt_number" id="txtreceipt_number" value="<?php echo get_receipt_number("Receipt")+1; ?>" >
</div> 
</div>
<br />
