...
<div class="main-content">
				...
				?>
                           ...
                           <div>
                            <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Admin/new_subject_add/'.$class_id; ?>">Add Subject</a></div> 
<br>
                                    <div class="table-responsive">
											...
											{
		 ?>
		 <a href="<?php echo base_url();?>index.php/admin/teacher_profile/<?php echo $row['teacher_id'];?>" data-toggle="tooltip" title="View Profile"> <?php 
                                                     ...
                                                     <?php
													  ...
													  echo "---"?></td><td style="text-align: center;">
																...
																<?php
                echo anchor('Admin/subject_edit/' .$class_id.'/'.$row['subject_id'].'/'.$row['teacher_id'], '<i class="fa fa-edit text-info"></i>');
                ?>
				</td>													
