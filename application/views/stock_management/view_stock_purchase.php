...
<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
					  ...
					  <!-- PAGE CONTENT BEGINS -->
   <div align="right" style="padding-bottom:10px" > <a href="<?php echo base_url();?>index.php/Stock_management/view_purchase" data-dismiss="fileinput"><button class="btn-info">Back</button></a></div>
	      	...
	      	<div class="col-md-12">
		        <div class="box">
		            <div class="table-header">
		             <center>Purchase details</center>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		            	<div class="col-sm-12 well well-sm">
			            	...
			            	<div class="col-md-4">
			            			...
			            			Total :	<b><?php echo $row['invoice_amount'];?></b>		            
			            	...
			            	<div class="col-md-3">
				            		...
				            		Discount:<b><h4><?php echo $row['discount_received'];?></h4></b>
				            		<br>
			            ...
			            <div class="col-sm-12" style="overflow-y: auto;">
			            	<table id="search-table" class="table table-striped table-bordered table-hover">
			            		...
			            		<tbody>
                                    ...
                                    <td><center><?php echo $value['purchase_quantity'];?></center></td>
                                    <td><center><?php echo $value['purchase_rate'];?></center></td>
                                    <td><center><?php echo $value['unit_long_name'];?></center></td>
                                    <td><center><?php echo $value['purchase_price'];?></center></td>
			            ...
			            <div class="col-sm-12">
			            	<div class="buttons">
								<div class="btn-group btn-group-justified">
									...
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('index.php/stock_management/pdf_purchase/');?><?php echo $row['purchase_master_id']; ?>" title="Download as PDF" target="_blank">
											<i class="fa fa-download"></i>
											<span class="hidden-sm hidden-xs"><?php echo $this->lang->line('product_alert_pdf'); ?></span>
										</a>
									</div>
									<div class="btn-group">
										<a class="tip btn btn-warning tip" href="<?php echo base_url('index.php/stock_management/edit_purchase/');?><?php echo $row['purchase_master_id']; ?>" title="Edit" >
