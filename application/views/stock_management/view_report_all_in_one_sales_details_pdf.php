...
<?php echo get_school_phone() ?>,<?php echo get_school_mail() ?></h3></div>
                      <div class="col-md-10" align="center"><b>SALES DETAILS</b>
                     <div class="box-body">
				    <?php	
					$prev_sales_id="";
                    ...
                    <div class="col-md-10" align="center">
                       ...
                       <td style="border:1px solid" ><center><b><?php echo  number_format($row['bill_amount'],2);?></b></center></td>
                       <td style="border:1px solid" ><center><b><?php echo  number_format($row['discount_allowed'],2);?></b></center></td>
