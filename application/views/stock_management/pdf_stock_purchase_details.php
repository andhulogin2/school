...
<?php echo get_school_phone() ?>,<?php echo get_school_mail() ?></h3></div>
                    ...
                    <?php foreach ($master as $row) { ?>
		            	<div class="col-sm-12 well well-sm" align="center">
		            		<b>Date : <?php echo $row['purchase_date'];?></b>
		            		<br>
		            		<b>Invoice NO : <?php echo $row['purchase_invoice_number'];?></b>
		            <div align="right">
		            	
		            		Total :	<b><?php echo $row['invoice_amount'];?></b>	&nbsp;&nbsp;Discount:<?php echo $row['discount_received'];?>
			            ...
			            <div class="col-sm-12" style="overflow-y: auto;margin-top: 4%">
			            	<table class="table table-hover table-bordered" width="100%" style="border:1px solid;border-collapse:collapse">
			            		...
			            		<tbody>
                                    ...
                                    <td style="border:1px solid"><center><?php echo $value['purchase_quantity'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo $value['purchase_rate'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo $value['unit_long_name'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo $value['purchase_price'];?></center></td>
