	...
	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <?php echo form_open('Stock_management/edit_sales_list/'.$key['sales_master_id'], array('class' => 'form-horizontal'));?>	
   ...
   <div class="form-group">
    ...
    <option value="<?php echo $bran['branch_id'];?>"<?php if($bran['branch_id'] == $key['branch_id']){?> selected <?php } ?>><?php echo $bran['branch_name'];?></option>
                       ...
                       <div class="form-group">
									...
									<input type="text" id="date" name="date" value="<?php echo $key['sales_date'];?>" class="form-control mydatepicker"  />
                          ...
                          <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="student"></label>
								<div class="col-sm-3">
								   <select name="student" class="select2" id="student" disabled />	
									 <option value="0">Select Student</option>
		                         <?php 
											foreach($stud as $student):
											?>
                                            <option value="<?php echo $student['student_id']; ?>"<?php if($student['student_id'] == $key['student_id']){ ?> selected <?php } ?>><?php echo $student['name']; ?></option>
                                            <?php
											endforeach;
											?>
				                   </select>
...
?>
                          ...
                          <td>
							...
							$this->db->where('item_master_id',$row['item_master_id']);
							$current_stock=$this->db->get('tbl_stock_item_master')->row()->current_stock;
							
							?>
                      <td><input type="number" class="form-control text-center" value="<?php echo $row['sales_quantity']; ?>" data-rule="quantity" 
                         name='qty<?php echo $counter; ?>' id='qty<?php echo $counter; ?>'   min="1" max="<?php echo $current_stock ?>"></td>
                          <td><input type='text' name='price<?php echo $counter; ?>' id='price<?php echo $counter; ?>' value="<?php echo $row['unit_rate']; ?>" readonly /></td>
                              <td><?php echo $row['unit_long_name']; ?></td>
                              <td><input type='text' class='form-control' style='' value="<?php echo $row['sales_amount']; ?>" name='linetotal<?php echo $counter; ?>'
				   ...
				   $counter++; ?>
                    ...
                    <input type="hidden" name="total_discount" id="total_discount" value="<?php  echo  $row['discount_allowed']; ?>">
                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover">
                      ...
                      <tr>
                        ...
                        <td align='right'><?php echo $this->session->userdata('symbol'); ?>
                          <span id="totalDiscount"><?php  echo $row['discount_allowed']; ?></span>
                        </td>
                      </tr>
...
if ($action=="Updated")
{
echo "<script>toastr.success('". "Sales-Stock updated successfully...', 'Inserted', {timeOut: 5000})</script>";
}
