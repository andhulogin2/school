<?php include_once APPPATH . 'views/main_head.php';?>
	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Edit Stock Brand</li>
						</ul><!-- /.breadcrumb -->
							...
							<h1>
                             ...
                             <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/Stock_management/view_stock_item_brand/<?php echo $brand_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                    ...
                                    <div>
                     <?php echo form_open('Stock_management/stock_item_brand_update/'.$brand_id, array('class' => 'form-horizontal'));?>
					 
										<center><div class="widget-box" style="width:420px">
											<div class="widget-header">
												<h4><font color="#FFFFFF">Edit Stock Brand</font></h4>
											</div>
		...
		<center><input type="text" id="brand_name"  name="brand_name" value="<?php echo urldecode($brand_name); ?>" /></center> 
