...
<?php echo get_school_phone() ?>,<?php echo get_school_mail() ?></h3></div>
                                <div align="center">SALES ITEMS REPORT</div>
                                    <br><br>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;border:1px solid">Student</th>
		            	...
		            	<tbody>
			            			...
			            			<tr>
                                    <td style="border:1px solid"><center><?php echo date('d-m-Y',strtotime($row['sales_date']));?></center></td>
                                    <td style="border:1px solid"><center><?php echo $row['item_name'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo $row['student'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo $row['sales_quantity'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo number_format($row['unit_rate'],2);?></center></td>
                                    <td style="border:1px solid"><center><?php echo $row['unit_long_name'];?></center></td>
                                    <td style="border:1px solid"><center><?php echo number_format($row['sales_amount'],2);?></center></td>
