							...
							<h1>
                             ...
                             <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/stock_management/view_stock_item_category/<?php echo $category_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                    ...
                                    <div>
                     <?php echo form_open('Stock_management/stock_item_category_add/', array('class' => 'form-horizontal'));?>
					 
										<center><div class="widget-box" style="width:420px">
											<div class="widget-header">
												<h4><font color="#FFFFFF">New Stock Item Category</font></h4>
											</div>
												...
												<div class="widget-main no-padding">
													<form>
														...
														<fieldset><br>
															...
															<center><input type="text" id="category_name" placeholder="Category Name" name="category_name" /></center> 
...
<script>
	...
	//alert(class_id);
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Stock_management/view_stock_item_category/' ,
