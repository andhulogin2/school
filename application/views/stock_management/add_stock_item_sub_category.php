				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">New Stock Item Category</li>
						</ul><!-- /.breadcrumb -->
                        ...
                        <div class="page-header">
							<h1>
								Create 
									...
									New Stock Item  Sub Category
								
							</h1>
                             <div align="right" style="padding-right:100px"> 
                              <?php $cls= $this->db->get_where('enroll',array('student_id'=>$student_id))->row()->class_id;?>    
                              <a href="<?php echo base_url();?>index.php/stock_management/view_stock_item_sub_category/<?php echo $category_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                   </div> 
						</div><!-- /.page-header -->
                                    ...
                                    <div>
                     <?php echo form_open('Stock_management/stock_item_sub_category_add/', array('class' => 'form-horizontal'));?>
                                        ...
                                        <div class="col-sm-9">
								<input type="text" id="sub_category_name" placeholder="sub category name"   class="col-xs-10   col-sm-5" name="sub_category_name" required />
										</div>
									   </div>
...
<script>
	...
	//alert(class_id);
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Stock_management/view_stock_item_sub_category/' ,
