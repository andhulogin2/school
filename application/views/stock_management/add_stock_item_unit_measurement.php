                        ...
                        <div class="page-header">
							<h1>
								Create 
									...
									New Stock Item Unit Measurement
                             ...
                             <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/stock_management/view_stock_item_unit_measurement/<?php echo $unit_of_measurement_id;?>" data-dismiss="fileinput"><b><button class="btn-info">Back</button></b></a> 
                                    ...
                                    <div>
                     <?php echo form_open('Stock_management/stock_item_unit_measurement_add/', array('class' => 'form-horizontal'));?>
					 
                      <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Unit Short Name:<font color="#FF0000">*</font> </label>
                                        <div class="col-sm-9">
								<input type="text" id="unit_short_name" placeholder="unit short name"   class="col-xs-10   col-sm-5" name="unit_short_name" required />
										</div>
									   </div>
                      ...
                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
								<input type="text" id="unit_long_name" placeholder="unit long name"   class="col-xs-10   col-sm-5" name="unit_long_name" required />
										</div>
									   </div>
