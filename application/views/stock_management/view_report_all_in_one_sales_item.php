      	...
      	<div class="row">
	      	...
	      	<div class="col-md-12">
		        <div class="box box-info">
		            ...
		            <!-- /.box-header -->
                                       <div class="pull-right"><a href="<?php echo base_url('index.php/stock_management/pdf_sales_report_item/');?>" target="_blank "><i class="btn btn-info">Download</i></a></div>
		            	...
		            	<tbody>
                                    ...
                                    <td><center><?php echo $row['student'];?></center></td>
