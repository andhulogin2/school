...
<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div align="right" style="padding-right:10px"><a href="<?php echo base_url() . 'index.php/Stock_management/add_stock_item_category/'.$category_id; ?>" ><button class="btn-info">New Entry</button></a></div> 
                              <br> 
												  ...
												  foreach($log as $category):?>
													<tr>
														...
														<td>
																...
																<?php
                echo anchor('Stock_management/stock_item_category_edit/' .$category['category_id'].'/'.$category['category_name'], '<i class="fa fa-edit text-info" title="Edit"></i>');
                ?>
					</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    										
																

								<a href="<?php echo base_url();?>index.php/Stock_management/stock_item_category_delete/<?php echo $category['category_id']?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');">
...
if ($action=="success")
{
echo "<script>toastr.success('". "Stock Category name inserted successfully...', 'Inserted', {timeOut: 5000})</script>";
}
