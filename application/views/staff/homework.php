...
<table class="table table-bordered datatable">
    ...
    <tr>
        ...
        <th style="text-align: center;"><div>Section</div></th>
        <th style="text-align: center;"><div>Added by</div></th>
        <th style="text-align: center;"><div>Subject</div></th>
...
<tbody>
    ...
    foreach ($homeworks as $row):
        ...
        <tr>
            ...
            <td style="text-align: center;"><a href="<?php echo base_url(); ?>index.php/staff/homeworkroom/details/<?php echo $row['homework_code']; ?>">
                    <?php echo $row['title']; ?>
                </a>
            </td>
            ...
            <td style="text-align: center;">
                <a class="btn btn-info tooltip-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('View'); ?>" 
                   href="<?php echo base_url(); ?>index.php/staff/homeworkroom/details/<?php echo $row['homework_code']; ?>">
