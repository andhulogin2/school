...
<?php 
$edit_data		=	$this->db->get_where('sms_template' , array('id' => $t_id) )->result_array();
							...
							<h1>
								...
								<small>
									...
									New Class
                                        ...
                                        <div></div>
<?php echo form_open(base_url() . 'index.php/staff/update_template/'.$row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>                     
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name"  value="<?php echo $row['title'];?>" class="col-xs-10 col-sm-5" name="name" />
										</div>
									</div>
<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="content" value="<?php echo $row['content'];?>" class="col-xs-10 col-sm-5" name="content" ></textarea>
										</div>
									</div>
