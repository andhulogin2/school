...
<?php echo form_open(base_url() . 'index.php/staff/attendance_selector/'); ?>
<div class="row">
...
<div class="row">
    ...
    <div class="col-md-12">
    <div class="white-box">
        <?php echo form_open(base_url() . 'index.php/staff/attendance_update/' . $class_id . '/' . $section_id . '/' . $timestamp); ?>
