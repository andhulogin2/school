...
foreach($profile_info as $row):?>
          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="" style="100%">
              <div class="overlay-box">
                <div class="user-content"><a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']);?>" style="width:100px; height:100"></a>
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('teacher' , array('teacher_id' => $teacher_id))->result_array();
                ...
                ?>
                    <?php echo form_open(base_url() . 'index.php/staff/teacher_edit/do_update/'.$row2['teacher_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
            ...
            <div class="panel-body">
                   ...
                   $edit_datas = $this->db->get_where('teacher' , array('teacher_id' => $teacher_id))->result_array();
                    foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'index.php/staff/teacher_edit/change_password/'.$row3['teacher_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
