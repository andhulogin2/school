					...
					<!-- /section:basics/content.breadcrumbs -->
						...
						<div class="page-header">
                            ...
                            <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/staff/students_area/<?php echo $cls;?>"  data-dismiss="fileinput"><b><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Back</b></a> 
                                   </div> 
						</div><!-- /.page-header -->
...
<h3 class="box-title"><?php echo get_phrase('Send Message'); ?></h3>
          <?php echo form_open(base_url() . 'index.php/staff/individual_message/' .$student_id);?>
...
<input type="text" name="message_send" class="form-control" />                
            ...
            <br /><br />&nbsp;
<td></td>
<button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><?php echo get_phrase('Send'); ?>
    ...
    <?php } 
	 echo form_close();
               ...
               <?php
               $yr=get_running_year();
    $edit_data = $this->db->get_where('enroll', array('student_id' => $row['student_id'], 'year' => $get_running_year();
            ))->result_array();
    foreach ($edit_data as $row3){
        ?>
                ...
                <?php echo form_open(base_url() . 'index.php/staff/update_student/' . $row3['student_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
			...
			<br>
              ...
              <?php
				...
				//echo $result['class_id'];
                 ...
                 echo anchor(base_url() . 'index.php/staff/delete_student/' . $student_id ."/" .$class_id, 'Delete', array('class' => 'btn btn-danger waves-effect waves-light m-r-10')); ?> 
                <?php echo form_close();} ?>
            </div>
        </div>   
...
<!--<td style="text-align: center;"><a href="<?php echo base_url();?>index.php?staff/mark_message_bulk/<?php echo $class_id;?>/<?php echo $sec_id;?>/<?php echo $student_id;?>/<?php echo $row2['exam_id'];?>" class="btn btn-info">
				<font color="#FFFFFF"><?php echo get_phrase('Send All');?></font></a></td>-->
                                    ...
                                    <tbody>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <td style="text-align: center;"><a href="<?php echo base_url();?>index.php/staff/mark_message/<?php echo $class_id;?>/<?php echo $sec_id;?>/<?php echo $student_id;?>/<?php echo $row3['mark_obtained'];?>/<?php echo $row3['mark_total'];?>/<?php echo $average;?>/<?php echo $grade_id;?>/<?php echo $row2['exam_id'];?>/<?php echo $row3['name']; ?>" class="btn btn-info">
...
<?php */?>				 
     ...
     ?>
        ...
        <a href="<?php echo base_url();?>index.php/staff/student_print/<?php echo $student_id;?>/<?php echo $class_id;?>/<?php echo $sec_id;?>" class="btn btn-info" target="_blank">
  ...
  <?php include_once APPPATH . 'views/footer.php'; ?>
        ...
        <script type="text/javascript">
            function select_attendance(month) {
                $.ajax({
                    url: '<?php echo base_url(); ?>index.php/staff/get_attendance/' + month,
                    success: function (response)
                    {
                        jQuery('#section_holder').html(response);
                    }
...
function send_sms(class_id,section_id, student_id){
	$.ajax({
	    url: '<?php echo base_url();?>index.php/staff/attendance_sms/' + class_id + '/' + section_id + '/' + student_id ,
            success: function(response)
            {
				alert(response);
            }
