		                                    ...
		                                    $teacher=$this->db->get_where('teacher',array('teacher_id'=>$row['teacher_id']))->row()->name;
		                                              ...
		                                              echo $teacher;?></td><td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php
                echo anchor('staff/subject_edit/' .$class_id.'/'.$row['subject_id'].'/'.$row['teacher_id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>');
                ?>
                                             ...
                                             <?php
                echo anchor('staff/new_subject_add/'.$class_id, 'Add Subject');
                ?>		
