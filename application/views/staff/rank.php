...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php/staff/rank');?>
			<div class="col-md-3">
	...
	<div class="col-md-4" style="text-align: center;">
		...
		<div class="icon"><i class="entypo-docs"></i></div>
			...
			<h4 style="color: #696969;">Report<br>
              ...
              <a href="<?php echo base_url();?>index.php/staff/rank_print/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $exam_id;?>" class="btn btn-info" target="_blank">
...
<div class="row">
	...
	<div class="white-box">
		...
		<table class="table table-bordered">
			<thead>
				...
				<?php 
					...
					<?php /*?><a href="<?php echo base_url();?>index.php?staff/subject_message_individual/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $exam_id;?>/<?php echo $row['subject_id'];?>" class="btn btn-info" target="_blank">
		...
		<?php /*?><center>
			<a href="<?php echo base_url();?>index.php?staff/tab_sheet_print/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $exam_id;?>" class="btn btn-info" target="_blank">
...
if($('#send_grade').prop('checked') == true) {
    ...
    $(".preloader").show();
	$.ajax({
	    url: '<?php echo base_url();?>index.php/staff/subject_message/' + class_id + '/' + section_id + '/' + exam_id + '/' + subject_id + '/' +  grade + '/' + position +'/' +rmark , 
...
function send_message1(class_id,section_id,exam_id, subject_id){
 ...
 // alert(grade);
  //alert(position);
    $(".preloader").show();
	$.ajax({
	    url: '<?php echo base_url();?>index.php/staff/subject_message_individual/' + class_id + '/' + section_id + '/' + exam_id + '/' + subject_id + '/' +  grade + '/' + position+ '/' + rmark ,
            success: function(response)
            {
				alert(response);
            }
...
<script type="text/javascript">
	function get_class_subject(class_id) {	
			...
			alert(class_id);
		$.ajax({
            url: '<?php echo base_url();?>index.php/staff/get_report/' + class_id ,
            success: function(response)
            {
