...
<div class="main_data">
    ...
    <td style="text-align: center;"><?php echo $counter++; ?></td>
		<td style="text-align: center;">
			<a href="<?php echo base_url();?>index.php/staff/news_view/details/<?php echo $row['news_code'];?>"><?php echo $row['title'];?></a>
    </td>
    <td style="text-align: center;">
		...
		<td style="text-align: center;">
            	...
            	href="<?php echo base_url();?>index.php/staff/news_view/details/<?php echo $row['news_code'];?>">
               View
                </a>
