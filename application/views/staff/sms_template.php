        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <?php echo form_open('staff/add_class', array('class' => 'form-horizontal'));?>
                     
								<!-- PAGE CONTENT BEGINS -->
								
									<!-- #section:elements.form -->
									<div>
                                                                        <div align="right" style="padding-right:50px"><a href="<?php echo base_url() . 'index.php/staff/add_template/'; ?>">New Template</a></div><br> 
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="table-header">Templates</th>
														<th class="table-header">Message</th>
														<th class="table-header" colspan="3">Actions</th>
													</tr>
												</thead>
												...
												<tbody>
                                                  ...
                                                  if($row['title']!= 'admission' && $row['title']!='attendance'){?>
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<?php
                echo anchor('staff/template_edit/' .$row['id'], '<i class="fa fa-edit text-info"></i>');
                ?>

																	
																

					<a href="<?php echo base_url();?>index.php/staff/template_delete/<?php echo $row['id']?>" class="btn-sm btn-icon icon-left" onClick="return confirm('Are-you-sure');">
