...
<div class="main_data">
    <?php
$profile_info = $this->db->get_where('staff' , array('staff_id' => $staff_id))->result_array();
foreach($profile_info as $row):?>
          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="" style="100%">
              <div class="overlay-box">
                <div class="user-content"><a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="<?php echo $this->crud_model->get_image_url('staff', $row['staff_id']);?>"></a>
                  <h4 class="text-white"><?php echo $row['name']; ?></h4>
                  <h5 class="text-white"><?php echo $row['email'];?></h5>
                </div>
              </div>
            </div><br><hr>
            <center><h3 class="box-title">PersonalInfo</h3></center>
            <ul class="basic-list">
              <li>Name<span class="pull-right label-danger label"><?php echo $row['name'];?></span></li>
              <li>Username<span class="pull-right label-purple label"><?php echo $row['username'];?></span></li>
              <li>Phone<span class="pull-right label-red label"><?php echo $row['phone'];?></span></li>
              <li>Email<span class="pull-right label-success label"><?php echo $row['email'];?></span></li>
              <li>Birthday<span class="pull-right label-info label"><?php echo $row['birthday'];?></span></li>
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('staff' , array('staff_id' => $staff_id))->result_array();
                      foreach ($edit_data as $row2):
                ?>
                    <?php echo form_open(base_url() . 'index.php/staff/staff/do_update/'.$row2['staff_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                      <img src="<?php echo $this->crud_model->get_image_url('staffs' , $row2['staff_id']);?>" alt="...">
                    </div>
            ...
            <div class="panel-body">
                   ...
                   $edit_datas = $this->db->get_where('staff' , array('staff_id' => $staff_id))->result_array();
                    foreach($edit_datas as $row3):
                        ?>
                         <?php echo form_open(base_url() . 'index.php/staff/staff/change_password/'.$row3['staff_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
