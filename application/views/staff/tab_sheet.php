...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php/staff/tab_sheet');?>
			<div class="col-md-3">
    ...
    <div class="col-md-2">
		...
		<?php //echo form_open(base_url() . 'index.php/staff/mark_print_report/'.$class_id.'/'.$section_id.'/'.$exam_id);?>
...
if($('#send_grade').prop('checked') == true) {
    ...
    $(".preloader").show();
	$.ajax({
	    url: '<?php echo base_url();?>index.php/staff/subject_message/' + class_id + '/' + section_id + '/' + exam_id + '/' +  grade + '/' + position +'/' +rmark , 
