													...
													<div class="tab-content padding-4">
														...
														<div id="home2" class="tab-pane in active">
															...
															<div class="scrollable-horizontal" data-size="800">
																<?php echo form_open(base_url() . 'index.php/staff/new_private_message/');?>
...
<div class="row" id="absent">
                                                        ...
                                                        <div id="info3" class="tab-pane">
															...
															<div class="scrollable-horizontal" data-size="800">
                                                            <div class="col-md-3">
                                                            <?php echo form_open(base_url() . 'index.php/staff/new_sendall_message', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
          <div class="form-group">
...
<?php echo form_close(); ?>
                                                            ...
                                                            <?php echo form_open(base_url() . 'index.php/staff/new_malayalam_message/');?>
                                                            <div class="col-md-6">
          <div class="form-group">
...
<div class="compose-message-editor">
    ...
    <?php echo form_close(); ?>
														...
														<div id="info2" class="tab-pane">
															<div class="scrollable" data-size="100">
																<?php echo form_open(base_url() . 'index.php/staff/new_notification_message/');?>
...
<script type="text/javascript">
	...
	{
    	$.ajax({
            url: '<?php echo base_url();?>index.php/staff/get_student_details/' + class_id +'/' + $section_id,
            success: function(response)
            {
...
<script type="text/javascript">
  ...
  {
    	$.ajax({
            url: '<?php echo base_url();?>index.php/staff/get_template_content/' + id ,
            success: function(response)
            {
...
<script type="text/javascript">
  ...
  {
    	$.ajax({
            url: '<?php echo base_url();?>index.php/staff/get_count/' +message,
            success: function(response)
            {
...
<script type="text/javascript">	
 function get_details1(){
	 ...
	 jQuery('#absent').html("");
       ...
       $.ajax({
	    url: '<?php echo base_url();?>index.php/staff/get_absent_student_for_message/' + classid + '/' + section + '/' + date ,
            success: function(response)
            {
...
<script type="text/javascript">	
 function get_details3(){
	 jQuery('#absent1').html("");
       ...
       $.ajax({
	    url: '<?php echo base_url();?>index.php/staff/get_special_message_students/' + classid + '/' + section  ,
            success: function(response)
            {
				console.log(response);
