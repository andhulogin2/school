...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <?php $running_year = get_running_year();?>
  <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.php/staff/staff_dashboard">Dashboard</a></li>
 ...
 <!-- Tab panes -->
            ...
            <div class="white-box"> 
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/staff/student_portal/<?php echo $row['student_id'];?>"><img src="../../../../login2_school_sc-new/uploads/user.jpg" alt="user" class="img-circle img-responsive"></a></div>
 ...
 <input type="radio"  name="radcheck1" value="<?php echo $row['section_id'];?>" checked="checked"/>Roll No
         ...
         'class_id'=>$class_id , 'section_id' => $row['section_id'] , 'year' => $running_year))->result_array();
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/staff/student_portal/<?php echo $row2['student_id'];?>"><img src="../../../../login2_school_sc-new/uploads/user.jpg" alt="user" class="img-circle img-responsive"></a></div>
                    <div class="col-md-8 col-sm-8">
