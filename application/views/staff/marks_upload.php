...
<?php echo form_open(base_url() . 'index.php/staff/marks_selector'); ?>
<div class="row">
...
<div class="row">
                           ...
                           <?php echo form_open(base_url() . 'index.php/staff/marks_update1/' . $class_id . '/' . $section_id . '/' . $exam_id . '/' . $subject_id); ?>
...
<script type="text/javascript">
    function get_class_subject(class_id) {
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/staff/marks_get_subject/' + class_id,
...
<script type="text/javascript">
  ...
  {
    	$.ajax({
            url: '<?php echo base_url();?>index.php/staff/get_grade/' + g ,
            success: function(response)
            {
