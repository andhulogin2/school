        	...
        	<div class="main-content">
				<div class="main-content-inner">
				 ...
				 <!--   <div class="row">
                     ...
                     <?php echo form_open('Admin/add_teacher', array('class' => 'form-horizontal'));?>
                           ...
                           <div class="col-sm-5">
							<div class="fileinput fileinput-new" data-provides="fileinput">
                               ...
                               <div align="right">     
                              <a href="<?php echo base_url();?>index.php/staff/teacher_view" class="btn btn-success fileinput-exists" data-dismiss="fileinput">View Teacher</a>       
                                   </div> 
