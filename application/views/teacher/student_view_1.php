...
<?php
	...
	$class_teacher_id	=  $this->db->get('section')->row()->teacher_id;
?>
                   ...
                   <th style="text-align: center;" class="table-header">Student</th>
                    ...
                    foreach ($student as $row){
                        ...
                        <tr>
                           ...
                           <td>
                   <a href="<?php echo base_url();?>index.php/Teacher/student_portal/<?php echo $row['student_id'];?>" class="btn-sm btn-icon icon-left">
                            <i class="fa fa-user"></i>
                    </a>	
                    <!--&nbsp;
                   <a href="<?php echo base_url();?>index.php/teacher/send_message/<?php echo $row['student_id'];?>" class="btn-sm btn-icon icon-left" title="Send message">
