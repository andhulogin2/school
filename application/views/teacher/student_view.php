...
<script type="text/javascript">
	...
	//alert(class_id);
    	$.ajax({
            url: '<?php echo base_url();?>index.php/Teacher/get_teacher_class_section/' + class_id ,
...
<script type="text/javascript">
	...
	function view_students_list() 
	{
		...
		//alert(class_id);
    	$.ajax({
        url: '<?php echo base_url();?>index.php/Teacher/view_students_list/' + class_id +'/'+section_id,
            success: function(response)
            {
