...
<div class="row">
	<div class="col-md-2">
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>index.php/teacher/homeworkroom_edit/edit/<?php echo $homework_code;?>" 
		...
		<div class="main_data">	
			<?php include APPPATH . 'views/teacher/homework_details.php';?>
		</div>
</div>
