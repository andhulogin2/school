...
<a  href="<?php echo base_url();?>index.php/teacher/study_material_add/" 
        ...
        foreach ($study_material_info as $row) { ?>   
            <tr>
			   ...
			   echo "No file selected"; }
                ...
                <td style="text-align: center;">
                    <a href="<?php echo base_url();?>index.php/Teacher/study_material_edit/<?php echo $row['document_id']?>" class=" btn-sm btn-icon icon-left">
                            <i class="fa fa-edit text-info"></i>
                    </a></td><td style="text-align: center;">
                    <a href="<?php echo base_url();?>index.php/Teacher/study_material/delete/<?php echo $row['document_id']?>" class="btn-sm btn-icon icon-left" onclick="return confirm('Are-you-sure');">
