...
<div class="box-body" id="printableArea">
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              {
			  ?><i class="fa fa-pencil-square" style="color: #e81d26;"></i> No Diary &nbsp;&nbsp;&nbsp;<?php }?><a href="<?php echo base_url();?>index.php/teacher/attendance_print/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $month;?>" class="btn btn-info" target="_blank">
                        ...
                        <tbody>
                            ...
                            foreach ($students as $row) {
                                ...
                                <tr>
									...
									?>
                                    <td style="text-align: center;"><a href="<?php echo base_url();?>index.php/teacher/attendance_messages/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $student_id;?>/<?php echo $present;?>/<?php echo $total;?>/<?php echo $percentage;?>/<?php echo $month;?>" class="btn btn-info" target="_blank">
