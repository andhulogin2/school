...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <?php $running_year = get_running_year();?>
                       ...
                       <div class="row col-md-10"><font color="#FFFFFF">fdzffd</font></div>
                          <div class="pull-right">
               <a href="<?php echo base_url();?>index.php/report/student_area_print_report/<?php echo $class_id;?>"><h4><i class="fa fa-file-excel-o" aria-hidden="true"></i>
Download</h4></a> 
 ...
 <div class="row">
  <div class="white-box">
            ...
            <ul class="nav customtab nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"><font color="#000000">All Students</font></span></a></li>
               <?php $query = $this->db->get_where('section' , array('class_id' => $class_id)); 
                if ($query->num_rows() > 0):
                $sections = $query->result_array();
                foreach ($sections as $row2):?>
              <li role="presentation" class=""><a href="#<?php echo $row2['section_id'];?>" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs"><font color="#000000">Section <?php echo $row2['name'];?></font></span></a></li><?php endforeach;?>
        <?php endif;?>
            </ul>
...
<div id="alphabet_list" style="display:none">       
             ...
             foreach($students as $row):?> 
              ...
              <div class="white-box"> 
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/Teacher/student_portal/<?php echo $row['student_id'];?>"><img src="<?php echo $this->crud_model->get_image_url('student',$row['student_id']);?>" alt="user" class="img-circle img-responsive" height="40px" width="80px"></a></div>
                    <div class="col-md-8 col-sm-8">
                      <h3 class="box-title m-b-0"><a href="<?php echo base_url();?>index.php/Teacher/student_portal/<?php echo $row['student_id'];?>">
...
<div id="roll_list" >       
 ...
 <input type="radio"  name="radcheck1" value="<?php echo $row['section_id'];?>" checked="checked"/>Roll No
            ...
            <a href="<?php echo base_url();?>index.php/report/student_print_bulk_section/<?php echo $class_id;?>/<?php echo $row['section_id'];?>"><p><i class="fa fa-file-excel-o" aria-hidden="true"></i>
Progress Report</p></a> 
...
Download</p></a> 
         ...
         'class_id'=>$class_id , 'section_id' => $row['section_id'] , 'year' => $running_year))->result_array();
                ...
                <div class="row">
               <br /> <br />
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/Teacher/student_portal/<?php echo $row2['student_id'];?>"><img src="<?php echo $this->crud_model->get_image_url('student',$row2['student_id']);?>" alt="user" class="img-circle img-responsive" height="40px" width="80px"></a></div>
                    <div class="col-md-8 col-sm-8">
                      <h3 class="box-title m-b-0"><a href="<?php echo base_url();?>index.php/Teacher/student_portal/<?php echo $row2['student_id'];?>"><?php echo $row2['name'];?></a></h3>
