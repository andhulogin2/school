...
<div align="right" style="padding-right:10px">  
                              <a href="<?php echo base_url();?>index.php/Teacher/homework_add/"><b><button class="btn-info">Add</button></b></a> 
 </div>     
    ...
    foreach ($homeworks as $row):
        ...
        <tr>
           ...
           <td style="text-align: center;" class="text-nowrap">
                <a href="<?php echo base_url(); ?>index.php/teacher/homeworkroom/details/<?php echo $row['homework_code']; ?>">
                    <i class="fa fa-edit text-info"></i>
                </a></td>
<td style="text-align: center;" class="text-nowrap">
                <a href="<?php echo base_url(); ?>index.php/teacher/homework/delete/<?php echo $row['homework_code']; ?>">
