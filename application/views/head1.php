...
<div class="preloader">
 ...
 <!-- #section:basics/navbar.layout -->
    ...
    <?php if($this->db->get_where('settings' , array('type' =>'branch'))->row()->description == 'yes')
					   {?>
    <li class="">
    ...
    <li class="">
        ...
        <ul class="submenu">
            ...
            <!-- <li class="">
             ...
             <li class="">
                <?php
                echo anchor('Admin/staff_view/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Add Staff</span>');
                ?>
     ...
     <li class="">
        <a href="#" class="dropdown-toggle">
            <i class="menu-icon fa fa-desktop"></i>
            <span class="menu-text"> Hourly Attendance  </span> <b class="arrow fa fa-angle-down"></b>
        </a>
        <b class="arrow"></b>
        <ul class="submenu">
  <li class="">
               ...
               <li class="">
                <?php
                 echo anchor('Hourly_attendance/set_working_days/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Set Working Days</span>');
                ?>
                <b class="arrow fa fa-angle-down"></b>
                <b class="arrow"></b>
            </li>
             <li class="">
                ...
                <li class="">
                <?php
                echo anchor('Hourly_attendance/set_time_table/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Set Time Table</span>');
                ?>
                <b class="arrow fa fa-angle-down"></b>
                <b class="arrow"></b>
            </li>
     	...
     	<li class="">
                       ...
                       <li class="">
								<?php
                echo anchor('Admin/student_veiw/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Students</span>');
                ?>
								<b class="arrow"></b>
							</li>
                        </ul>
               ...
               // echo anchor('Admin/class_migration/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Class-Migrate</span>');
                ?>
                    ...
                    <li class="">
						...
						<ul class="submenu">
							<li class="">
								<?php
                echo anchor('Admin/subjects_view/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Subjects</span>');
                ?>
                ...
                ?>
                    ...
                    <?php  if($this->db->get_where('settings' , array('type' =>'study_meterial'))->row()->description == 'yes')
                     ...
                     <li class="">
						<?php
                echo anchor('Admin/study_material_add/', '<i class="menu-icon fa fa-file-text"></i><span>&nbsp;Study Materials</span>');
                ?>
					</li>
                    <?php } ?>
