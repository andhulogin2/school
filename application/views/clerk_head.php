 ...
 <!-- #section:basics/navbar.layout -->
		<div id="navbar" class="navbar navbar-default ace-save-state">
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
					<?php
					if($this->db->get_where('settings' , array('type' =>'acc_year_change'))->row()->description == 'yes')
					{
						if($this->db->get_where('settings' , array('type' =>'year_change_in_settings'))->row()->description != 'yes')
						{
							echo form_open('admin/change_academic_year_in_clerk');
    ...
    <li class="">
        <?php
                echo anchor('Admin/clerk_dashboard/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Dashboard</span>');
                ?>
...
<li class="">
		...
		?>
            <li class="">
             ...
             <li class="">
              <?php
                echo anchor('Transport_management/view_student_bus_fee_pay/', '<i class="menu-icon fa fa-caret-right"></i><span>&nbsp;Student Bus Fee Payment </span>');
                ?>
                <b class="arrow fa fa-angle-down"></b>
                <b class="arrow"></b>
            </li>
