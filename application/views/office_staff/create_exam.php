             ...
             <?php $role=$this->session->userdata('role');
				...
				<div class="padded">
                 <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="branch" class="col-xs-12 col-sm-12" id="branch" onChange="return get_dept(this.value)" required="">
                              ...
                              <?php }?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="department" class="col-xs-12 col-sm-12" id="department" onChange="return get_class(this.value)" required="">
                              <option value="">Select</option>
                   ...
                   <div class="form-group">
										...
										<div class="col-sm-5">
									<select name="class" id="class" class="col-xs-12 col-sm-12" required="" onChange="return get_class_sections(this.value)">
                                     <option value="">Select</option>
                          </select>
...
{?>
		...
		<div class="form-group">
										...
										<div class="col-sm-5">
			<select name="department" class="col-xs-12 col-sm-12" id="department" onChange="return get_class1(this.value)" required="">
            <option value="">Select</option>
...
<div class="form-group">
										...
										<div class="col-sm-5">
			<select name="class"class="form-control selectboxit" onchange="select_section(this.value)" id="class1" class="col-xs-12 col-sm-12">
				<option value="">Select</option>
...
{?>
		...
		<label class="col-sm-4 control-label no-padding-right" for="form-field-1-1">Class:<font color="#FF0000">* </font> </label>
        <div class="col-sm-5">
			<select  name="class" class="form-control selectboxit" onchange="select_section(this.value)" id="class" class="col-xs-12 col-sm-12">
				<option value="">Select</option>
                <?php 
    ...
    <?php }?>
		     		 <div class="form-group">
                    <label class="col-sm-4 control-label">Unit_test<font color="#FF0000">* </font></label>
                    <div class="col-sm-5">
					...
					<div class="form-group">
                    <label class="col-sm-4 control-label">Description<font color="#FF0000">* </font></label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="comment" placeholder="Description" class="col-xs-12 col-sm-12">
                  </div>
                            </div>
