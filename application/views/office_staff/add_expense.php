...
<div class="col-sm-10 widget-container-col">
						...
						<?php echo form_open(base_url() . 'index.php/office_staff_/expense_add ' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
			...
			<select  name="category1" class="form-control selectboxit" id="category" class="col-xs-12 col-sm-12">
                ...
                <?php 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="give_to" >
                    </div>
                  </div>
                  <div class="form-group">
