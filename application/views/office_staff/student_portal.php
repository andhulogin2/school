								...
								<div class="col-sm-12">
										...
										<div class="tabbable">
											<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
												...
												?>
												<li>
                                                <a data-toggle="tab" href="#dropdown16">HOURLY ATTENDANCE REPORT</a>
...
<center>
                        ...
                        ?></span>
                                                ...
                                                <div class="profile-info-row">
													<div class="profile-info-name"><center> Admission Number</center></div>

													<div class="profile-info-value">
														<span class="editable" id="username"><?php
                        echo $student_view['admission_number'];
                        ?></span>
													</div>
												</div>
...
<button type="submit" class="btn btn-info waves-effect waves-light m-r-10" onclick="preloader()"><?php echo get_phrase('Send'); ?>
    ...
    foreach ($edit_data as $row3){
        ?>
                ...
                <?php echo form_open(base_url() . 'index.php/Office_staff/update_student/' . $row3['student_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
 ...
 class="form-control" placeholder="<?php echo get_phrase('Roll No'); ?>">
                    ...
                    <div class="form-group">
                    <label class="col-md-12"><?php echo get_phrase('Admission NO'); ?></span></label>
                    <div class="col-md-12">
...
<?php */?>				 
 ...
 <div id="dropdown16" class="tab-pane">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <b><h4 class="page-title"><center><center>&nbsp;&nbsp;&nbsp;<font color="#000000"><?php echo get_phrase('Hourly-Attendance-Report'); ?></font></center></center></h4> </b></div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
    ...
    <div class="white-box">
        <div class="row">
            ...
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1-1">Subject </label>
                                        
										<div class="col-sm-2">
			 								<input type="hidden"  id="student"  class="form-control "  name="student" value="<?php echo $student_id;?>"  />
													 <select name="subject_id"  required="" id="subject_id" >
                                                     <option>Select</option>
                                                     <?php 
													 $this->db->where('class_id',$class_id);
													 $sub=$this->db->get('subject')->result_array();
										...
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1-1">From Date: </label>
                                        
										<div class="col-sm-2">
			 								
													<input type="text"  id="mydatepicker"  class="form-control mydatepicker"  name="from_date"  />
										...
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1-1">To Date: </label>
                                        
										<div class="col-sm-2">
			 								
													<input type="text"  id="mydatepicker1"  class="form-control mydatepicker"  name="to_date"  />
													
												</div>
 <a class="btn btn-info" name="btnView" onclick="view_attendance_list1()">View Attendance</a>
