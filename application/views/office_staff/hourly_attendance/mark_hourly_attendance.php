				...
				<div class="padded">
                 <div class="form-group">
                   ...
                   <div class="form-group">
										...
										<div class="col-sm-9">
									<select name="class_id" id="class_id" class="col-xs-10 col-sm-5" required="" onChange="get_class_sections(this.value);get_class_subject(this.value);">
                                     <option value="">Select</option>
                          </select>
...
<div class="form-group">
										...
										<div class="col-sm-9">
			<select name="class_id" class="form-control selectboxit" onchange="get_class_sections(this.value);get_class_subject(this.value);" id="class_id" class="col-xs-12 col-sm-12" >
				<option value="">Select</option>
...
{?>
		...
		<div class="form-group">
         ...
         <div class="col-sm-9">
			<select  name="class_id"  onchange="get_class_sections(this.value);get_class_subject(this.value);" id="class_id" class="col-xs-10 col-sm-5">
				<option value="">Select</option>
                <?php 
