...
<?php $teacher=$this->session->userdata('login_user_id');?>
				...
				<?php $role=$this->session->userdata('role');
					 ...
					 {?>
                                    <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="branch" class="form-control" id="branch" onChange="return get_dept(this.value)" required="">
                              ...
                              <?php }?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="department" class="form-control" id="department" onChange="return get_class(this.value)" required="">
                              <option value="">Select</option>
				...
				if($role==3)
                     ...
                     <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="department" class="form-control" id="department" onChange="return get_class1(this.value)" required="">
                              <option value="">Select</option>
                    ...
                    <div class="col-sm-5">
                        <select name="class_id" class="form-control selectboxit" id="class1" onchange="return get_class_subject(this.value)" required="">
                            <option value=""><?php echo get_phrase('Select'); ?></option>
