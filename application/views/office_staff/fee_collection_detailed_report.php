...
<body>
			...
			<select name="department" class="col-xs-10 col-sm-5" id="department" onChange="return get_class(this.value)">
                   ...
                   <div class="form-group">
										...
										<div class="col-sm-9">
									<select name="class_id" id="class" class="col-xs-10 col-sm-5" required="" onChange="return get_class_sections(this.value)">
                                     <option value="">Select</option>
                          </select>
...
<div class="form-group">
										...
										<div class="col-sm-9">
			<select name="class_id" onChange="get_class_sections1(this.value)" id="class1" class="col-xs-10 col-sm-5">
				<option value="">Select</option>
...
{?>
		...
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Class:<font color="#FF0000">* </font> </label>
        <div class="col-sm-9">
			<select  name="class_id"  onchange="get_class_sections(this.value)" id="class" class="col-xs-10 col-sm-5">
				<option value="">Select</option>
                <?php 
