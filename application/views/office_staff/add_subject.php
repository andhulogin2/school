					...
					<div class="page-content">
                        ...
                        <div class="page-header">
                            ...
                            <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/admin/subjects_view/" data-dismiss="fileinput"><b><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Back</b></a> 
                                   </div> 
						</div><!-- /.page-header -->
                                        ...
                                        <div></div>
                     <?php echo form_open('office_staff/add_subject/'.$class_id, array('class' => 'form-horizontal'));
					 ?>
