...
<body>
        	<div class="main-content">
                ...
                <?php echo form_open(base_url() . 'index.php/office_staff/print_students_list1' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
