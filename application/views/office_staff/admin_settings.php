                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-xs-3">
                    ...
                    <div class="col-xs-3">
													<label>
														<input type="checkbox" value="yes" <?php if($this->db->get_where('settings' , array('type' =>'branch'))->row()->description == 'yes') echo 'checked';?> name="branch" class="ace ace-switch ace-switch-2" data-color="#13dafe" />
														<span class="lbl"></span>
													</label>
												</div>
                    ...
                    <div class="col-xs-3">
													<label>
														<input type="checkbox" value="yes" <?php if($this->db->get_where('settings' , array('type' =>'designation'))->row()->description == 'yes') echo 'checked';?> name="designation" class="ace ace-switch ace-switch-2" data-color="#13dafe" />
														<span class="lbl"></span>
													</label>
												</div>
                    ...
                    <div class="col-xs-3">
													<label>
														<input type="checkbox" value="yes" <?php if($this->db->get_where('settings' , array('type' =>'department'))->row()->description == 'yes') echo 'checked';?> name="department" class="ace ace-switch ace-switch-2" data-color="#13dafe" />
														<span class="lbl"></span>
													</label>
												</div>
