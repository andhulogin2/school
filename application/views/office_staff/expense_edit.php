        ...
        <div class="col-sm-5">
			<select  name="category1" class="form-control selectboxit" id="category" class="col-xs-12 col-sm-12">
                ...
                <?php 
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Give to<font color="#FF0000">* </font></label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="give_to" value="<?php echo $row['give_to']; ?>" placeholder="give to">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Remark<font color="#FF0000">* </font></label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="remark" value="<?php echo $row['remark']; ?>" placeholder="Remark">
                    </div>
                  </div>
