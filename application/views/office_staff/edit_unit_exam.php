            ...
            <?php $role=$this->session->userdata('role');
				...
				<div class="padded">
                 <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="branch" class="col-xs-12 col-sm-12" id="branch" required="" onChange="return get_dept(this.value)">
                              ...
                              <?php
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-5">
											<select name="department" class="col-xs-12 col-sm-12" id="department" required=""  onChange="return get_class1(this.value)">
                              <option value="">Select</option>
...
<div class="form-group">
										...
										<div class="col-sm-5">
			<select name="class" class="form-control selectboxit" onchange="select_section(this.value)" id="class" class="col-xs-12 col-sm-12" required="">
				<option value="">Select</option>
				<?php $class=$this->db->get('class')->result_array();
							  foreach ($class as $class1)
							  {
...
{?>
        ...
        <div class="col-sm-5">
			<select  name="class"  onchange="select_section(this.value)" id="class_id" class="col-xs-12 col-sm-12" required="">
				<option value="">Select</option>
                <?php 
    ...
    <?php }?>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">Unit Test</label>
                    <div class="col-sm-5">
