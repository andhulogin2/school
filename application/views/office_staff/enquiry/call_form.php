...
<body>
	    ...
	    <!-- #section:elements.form -->
			   ...
			   <div class="form-group">
								   ...
								   <input type="text"  class="form-control mydatepicker" name="date" required="" placeholder="Date of Enquiry"/>
...
<div class="space-2"></div>
								   ...
								   <div class="form-group">
								   <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Next Date of Call: </label>
								   <div class="col-sm-2">
								   <div class="clearfix">
											<!-- #section:plugins/date-time.datepicker -->
								   <div class="input-group input-group-sm">
								   <input type="text" class="form-control mydatepicker" name="call_date" required="" placeholder="Next Date of Enquiry"/>
                                   <span class="input-group-addon">
								   <i class="ace-icon fa fa-calendar"></i>
								   </span>
						      	   </div>
