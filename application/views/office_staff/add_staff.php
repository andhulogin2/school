        	...
        	<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
                     ...
                     <div align="right">     
                              <a href="<?php echo base_url();?>index.php/admin/staff_view" class="btn btn-success fileinput-exists" data-dismiss="fileinput">View Staff</a>       
                                   </div> 
                     ...
                     <?php 
								...
								<!-- PAGE CONTENT BEGINS -->
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<select name="designation" class="col-xs-10 col-sm-5" id="designation" onChange="get_branch(this.value)" required="" >
                              ...
                              <option value="">Select</option>
                                   ...
                                   <?php  if($role==3){?>
                                    <div class="form-group" id="dept_role">
										...
										<div class="col-sm-9">
											<select name="department" class="col-xs-10 col-sm-5" id="department" required="" >
                              <option value="">Select</option>
                              <?php 
