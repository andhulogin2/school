<?php include_once APPPATH . 'views/main_head.php';?>
        	...
        	<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="page-header">
                            ...
                            <div align="right" style="padding-right:100px"> 
                              ...
                              <a href="<?php echo base_url();?>index.php/admin/section/<?php echo $cls;?>"  data-dismiss="fileinput"><b><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Back</b></a> 
                                   </div> 
						</div><!-- /.page-header -->
                       ...
                       <?php echo form_open('Admin/add_section', array('class' => 'form-horizontal'));?>
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="Section Name" class="col-xs-10 col-sm-5" name="name" required/>
										</div>
									</div>
                                   <div class="form-group">
										...
										<div class="col-sm-9">
											<select name="class_id" class="col-xs-10 col-sm-5" required>
				...
				$classes = $this->db->get('class')->result_array();
                              ...
                              <option value="">Select</option>
                              <?php 
							  		/*$this->db->join('staff','tbl_users.user_id=staff.role','left');
							  		$this->db->where('tbl_users.user_role_id',6);
									$this->db->where('staff.role',6); 
									$teachers = $this->db->get('tbl_users')->result_array();*/
									if($role==3)
				{
				$this->db->where('branch_id',$this->session->userdata('branch_id'));
				}
