...
<div id="alphabet_list" style="display:none">       
             ...
             foreach($students as $row):?> 
              ...
              <div class="white-box"> 
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/Office_staff/student_portal/<?php echo $row['student_id'];?>/<?php echo $class_id;?>"><img src="<?php echo $this->crud_model->get_image_url('student',$row['student_id']);?>" alt="user" class="img-circle img-responsive" height="40px" width="80px"></a></div>
                    <div class="col-md-8 col-sm-8">
                      <h3 class="box-title m-b-0"><a href="<?php echo base_url();?>index.php/Office_staff/student_portal/<?php echo $row['student_id'];?>/<?php echo $class_id;?>">
...
Download</p></a> 
         ...
         'class_id'=>$class_id , 'section_id' => $row['section_id'] , 'year' => $running_year))->result_array();
                ...
                <div class="row">
               <br /> <br />
                    <div class="col-md-4 col-sm-4 text-center"><a href="<?php echo base_url();?>index.php/Office_staff/student_portal/<?php echo $row2['student_id'];?>/<?php echo $class_id;?>"><img src="<?php echo $this->crud_model->get_image_url('student',$row2['student_id']);?>" alt="user" class="img-circle img-responsive" height="40px" width="80px"></a></div>
                    <div class="col-md-8 col-sm-8">
                      <h3 class="box-title m-b-0"><a href="<?php echo base_url();?>index.php/Office_staff/student_portal/<?php echo $row2['student_id'];?>"><?php echo $row2['name'];?></a></h3>
